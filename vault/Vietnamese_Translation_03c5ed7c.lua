...
-- Script ID: 03c5ed7c1f865cf5d92108962695e7b7
-- Updated: 2025-09-11T19:25:59.784Z
...
Tab:AddParagraph({
    Title = "Trạng thái",
    Content = "Hoạt động tốt nhất trong Single Player"
})

godModeToggle = Tab:AddToggle("GodMode", {
    Title = "Đóng băng kẻ thù(Chế độ thần thánh)",
    Default = false,
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "Hoàn thành tất cả các mục tiêu",
    Default = false,
    Callback = function(Value)
...
ObjectiveSection:AddToggle("InstantCompleteV2", {
    Title = "Hoàn thành ngay lập tức tất cả các mục tiêu V2 (Chỉ dành cho trường học)",
    Default = false,
    Callback = function(Value)
...
TeleportSection:AddButton({
    Title = "Điểm an toàn trên bản đồ 2",
    Callback = function()
        pcall(function()
            local Character = Player.Character
...
CombatSection:AddToggle("AllSkills", {
    Title = "Kích hoạt tất cả các kỹ năng",
    Default = false,
    Callback = function(Value)
        pcall(function()
...
CombatSection:AddToggle("InfPerk", {
    Title = "Kích hoạt kỹ năng đặc biệt",
    Default = false,
    Callback = function(Value)
        pcall(function()
            InfPerkActive = Value
