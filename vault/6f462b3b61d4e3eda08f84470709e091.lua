-- German Translation
-- Script ID: 6f462b3b61d4e3eda08f84470709e091
-- Updated: 2025-12-18T07:41:50.596Z
...
local Tabs = {
    ...
    AimAssist = Window:AddTab("Ziel-Assistent", "star"),
    Visuals = Window:AddTab("Visuelles", "eye"),
    ["UI Settings"] = Window:AddTab("UI-Einstellungen", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("Auto-Spiel-Schleife")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("Version 1 - Manuell PC")
local AimbotV2Box = Tabs.AimAssist:AddRightGroupbox("Version 2 - Automatisch")
local TriggerBox = Tabs.AimAssist:AddLeftGroupbox("Auto-Schuss")
local ESPBox = Tabs.Visuals:AddLeftGroupbox("Spieler-ESP")
local TracerBox = Tabs.Visuals:AddRightGroupbox("Verfolger")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("AutoPlay", {
    Text = "Auto-Spiel-Schleife",
    Default = false,
    Tooltip = "Automatisch respawnen beim Tod",
})
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "Aktivieren",
    Default = false,
    Tooltip = "Rechtsklick halten zum Sperren",
})
...
AimbotV1Box:AddDropdown("AimbotV1Part", {
    Values = {"Kopf", "Torso", "Zentrum"},
    Default = 1,
    Text = "Zielteil",
})

Options.AimbotV1Part:OnChanged(function()
    local mapping = {["Kopf"] = "Head", ["Torso"] = "Torso", ["Zentrum"] = "HumanoidRootPart"}
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "Aktivieren",
    Default = false,
    Tooltip = "Auto-Sperre ohne Taste",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "Aktivieren",
    Default = false,
    Tooltip = "Auto-Schuss beim Sperren",
})
                ...
                if player ~= LocalPlayer and Module.isAlive(player) then
                    ...
                    if hrp then
                        ...
                        if onScreen then
                            ...
                            local fromPos
                            if Options.TracerPosition.Value == "Oben" then
                                fromPos = Vector2.new(Camera.ViewportSize.X / 2, 0)
                            elseif Options.TracerPosition.Value == "Mitte" then
...
MenuGroup:AddLabel("Menü-Tastenkombination"):AddKeyPicker("MenuKeybind", {
    Default = "RightShift",
    NoUI = true,
