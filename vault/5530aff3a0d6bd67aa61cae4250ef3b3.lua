...
-- Script ID: 5530aff3a0d6bd67aa61cae4250ef3b3
-- Migrated: 2025-09-11T12:58:33.811Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_91c6f25189d37439__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_be5336ecdf6cdd1d__"))()
...
Tab:AddParagraph({
    Title = "신 모드 상태 신 모드는 스크립트 로드 시 자동으로 활성화됩니다",
    Content = "싱글 플레이어에서 가장 잘 작동합니다"
})
