...
-- Script ID: 10c4296adb5466c5200948f3f110a615
-- Migrated: 2025-09-11T14:25:42.592Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_c2c6482c5b1623ed__"))()
local SaveManager = loadstring(game:HttpGet("__URL_309cbcca6ae8b108__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_b41bbb78672b326f__"))()
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "Spawn-Gegenstände", Icon = "package" })
}
...
local PlatformDropdown = Tabs.Spawn:AddDropdown("PlatformDropdown", {
    Title = "Wählen Sie eine Platform",
    Values = Platforms,
    Multi = false,
    Default = 1,
})
