...
-- Script ID: 20450b944a19bc2d052fed1261915a97
-- Created: 2025-12-31T16:39:04.850Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local MainGroup = Tabs.Validation:AddLeftGroupbox("Ilagay ang Iyong Key")
    ...
    MainGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "Nakopya",
                Description = "Link ng key nakopya sa clipboard",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        Text = "📺 Channel sa YouTube",
        Func = function()
            setclipboard("https://www.youtube.com/@COMBO_WICK")
            Library:Notify({
                Title = "Nakopya",
                Description = "Link sa YouTube nakopya sa clipboard",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        Text = "💬 Server sa Discord",
        Func = function()
            setclipboard("https://discord.gg/9FWBQnVXCy")
            Library:Notify({
                Title = "Nakopya",
                Description = "Link sa Discord nakopya sa clipboard",
                Time = 2
            })
        end
    })
    ...
    HWIDGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "Nakopya",
                Description = "HWID nakopya sa clipboard",
                Time = 2
            })
        end
    })
