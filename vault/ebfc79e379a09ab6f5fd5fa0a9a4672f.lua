...
-- Script ID: ebfc79e379a09ab6f5fd5fa0a9a4672f
-- Migrated: 2025-09-11T13:21:24.537Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_23c5716849fe771a__"))()
local SaveManager = loadstring(game:HttpGet("__URL_9aa183a2a8c3dc4b__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_2abc74044a6b75d2__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Haupt", Icon = "" })
}
...
local UpgradesButton = Tabs.Main:AddButton({
    Title = "Teleportieren zu Upgrades",
    Callback = function()
        teleportToUpgrades()
    end
})
