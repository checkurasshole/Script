...
-- Script ID: 872c095148a05eab13c1ba7cb7e34073
-- Migrated: 2025-09-11T13:20:58.385Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_8dfaede1503ec524__"))()
...
local Tab = Window:AddTab({ Title = "メイン", Icon = "" })
local ShopTab = Window:AddTab({ Title = "ショップ", Icon = "" })
...
Tab:AddToggle("AutoFarm", {Title = "オートファーム", Default = false}):OnChanged(function(value)
...
Tab:AddToggle("AutoSell", {Title = "自動販売", Default = false}):OnChanged(function(value)
