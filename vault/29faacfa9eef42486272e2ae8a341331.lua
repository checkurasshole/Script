...
-- Script ID: 29faacfa9eef42486272e2ae8a341331
-- Created: 2025-10-18T02:33:51.253Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("HWID情報")
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("クイックリンク")
