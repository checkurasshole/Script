...
-- Script ID: 357a51dd4143702b19e0777e9616df04
-- Migrated: 2025-09-11T12:58:40.719Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_d00a0feaa8a6e401__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_b197d6dbc17a3086__"))()
...
ToggleButton.Text = "Interfaccia grafica"
...
Tab:AddParagraph({
    Title = "Modalità God La modalità God è abilitata automaticamente al caricamento dello...",
    Content = "Funziona meglio in modalità giocatore singolo"
})
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "Completamento automatico dell'obiettivo",
    Default = false,
...
AutoTeleportToggle = TeleportSection:AddToggle("AutoTeleport", {
    Title = "Teletrasporto automatico",
    Default = false,
    Callback = function(Value)
        pcall(function()
...
CombatSection:AddToggle("BufferSpam", {
    Title = "Attacco automatico attivo",
    Default = false,
    Callback = function(Value)
        pcall(function()
