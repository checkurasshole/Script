...
-- Script ID: 5bd5a95a1ca0ec8f927b6d9869cc7d15
-- Migrated: 2025-09-11T14:25:40.383Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_73c46beb3c6085d2__"))()
local SaveManager = loadstring(game:HttpGet("__URL_3dac6ac6ca011349__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_cc77a499ed5a3b41__"))()
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "スポーンアイテム", Icon = "package" })
}
