...
-- Script ID: 81f74c45b0b0a848c7c9a958c8372f6c
-- Created: 2025-10-10T17:13:43.603Z
-- Source: External API
...
local Tabs = {
    ...
    PrivateServer = Window:AddTab({ Title = "Частный сервер", Icon = "lock" })
}
...
local saveFileName = "Инфденежные средства активированы_" .. LocalPlayer.UserId .. ".txt"
...
Tabs.PrivateServer:AddButton({
    Title = "Присоединиться к частному серверу",
    Callback = function()
