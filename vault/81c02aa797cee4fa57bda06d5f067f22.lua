...
-- Script ID: 81c02aa797cee4fa57bda06d5f067f22
-- Migrated: 2025-09-11T13:21:19.272Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_552f956d7a545cff__"))()
local SaveManager = loadstring(game:HttpGet("__URL_2fa6f8988f4fe80f__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_9fe6d4f4d5ae245c__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Principal", Icon = "activity" }),
    Shop = Window:AddTab({ Title = "Loja", Icon = "shopping-cart" }),
    AntiAFK = Window:AddTab({ Title = "Sem pontapé", Icon = "shield" })
}
...
Tabs.Shop:AddToggle("AutoLeg", {
    Title = "Comprar Pernas Automaticamente",
    Default = false,
    Callback = function(Value)
        autoBuyLeg = Value
        if Value then
...
Tabs.Shop:AddToggle("AutoArm", {
    Title = "Comprar Braços Automaticamente", 
    Default = false,
    Callback = function(Value)
        autoBuyArm = Value
        if Value then
...
Tabs.Shop:AddToggle("AutoHead", {
    Title = "Cabeça de compra automática",
    Default = false,
    Callback = function(Value)
        autoBuyHead = Value
        if Value then
