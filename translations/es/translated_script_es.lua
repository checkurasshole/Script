...
local Window = Rayfield:CreateWindow({
    Name = 'Bóveda de ComboCronicle  UP...',
...
local AutoStealTab = Window:CreateTab('Robo automático', 4483362458)

-- Main Tab Elements
local RemoveWallsButton = MainTab:CreateButton({
    Name = 'Eliminar todos los muros',
    Callback = function()
        removeWalls()
        Rayfield:Notify({
            Title = 'Paredes eliminadas',
            Content = 'Se han eliminado todas las paredes, ventanas y techos',
            Duration = 3,
            Image = 4483362458,
        })
    end,
...
local AutoLockToggle = MainTab:CreateToggle({
    Name = 'Bloqueo automático de la base',
    CurrentValue = false,
    Flag = 'AutoLockToggle',
