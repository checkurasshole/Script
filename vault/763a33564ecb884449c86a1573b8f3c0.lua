...
-- Script ID: 763a33564ecb884449c86a1573b8f3c0
-- Created: 2025-10-27T03:13:23.229Z
-- Source: External API
...
local MapConfigs = {
	{
		Name = "Sehr schnell",
		DisplayName = "Schnellste automatische Candy",
		Maze = Mazes:WaitForChild("Cornfield2"),
		FastMode = true,
	},
	{
		Name = "Bewaffnet",
		DisplayName = "Bewaffnet",
	...
	{
		Name = "FriedhofGauntlet",
		DisplayName = "Friedhof Gauntlet",
		Maze = Mazes:WaitForChild("Castle2"),
	},
	{
		Name = "Kürbispfad",
		DisplayName = "Kürbispfad",
		Maze = Mazes:WaitForChild("Cornfield2"),
	},
}
...
if not moduleLoaded then
	...
	for i, mapConfig in ipairs(MapConfigs) do
		local toggleName = "Umschalten" .. mapConfig.Name
		
		MainBox:AddToggle(toggleName, {
			Text = mapConfig.DisplayName,
			Default = false,
			Tooltip = "Betrieb" .. mapConfig.Name,
		})
