...
-- Script ID: 45c04d0356515c9eaaa737a5182ed29d
-- Created: 2025-10-18T02:33:52.774Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("HWID信息")
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("快速链接")
