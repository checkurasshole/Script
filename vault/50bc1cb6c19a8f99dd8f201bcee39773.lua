...
-- Script ID: 50bc1cb6c19a8f99dd8f201bcee39773
-- Updated: 2025-12-18T07:41:36.495Z
...
local Tabs = {
    ...
    AimAssist = Window:AddTab("Tulong sa Aim", "star"),
    Visuals = Window:AddTab("Visual", "eye"),
    ["UI Settings"] = Window:AddTab("Settings ng UI", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("Auto Play Loop")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("Bersyon 1 - Manual PC")
local AimbotV2Box = Tabs.AimAssist:AddRightGroupbox("Bersyon 2 - Awtomatiko")
local TriggerBox = Tabs.AimAssist:AddLeftGroupbox("Auto Putok")
local ESPBox = Tabs.Visuals:AddLeftGroupbox("ESP ng Manlalaro")
local TracerBox = Tabs.Visuals:AddRightGroupbox("Mga Tracer")
...
AutoPlayBox:AddToggle("AutoPlay", {
    Text = "Auto Play Loop",
    Default = false,
    Tooltip = "Auto respawn kapag namatay",
})
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "I-enable",
    Default = false,
    Tooltip = "Hawakan ang right click para mag-lock",
})
...
AimbotV1Box:AddDropdown("AimbotV1Part", {
    Values = {"Ulo", "Katawan", "Gitna"},
    Default = 1,
    Text = "Target na Parte",
})

Options.AimbotV1Part:OnChanged(function()
    local mapping = {["Ulo"] = "Head", ["Katawan"] = "Torso", ["Gitna"] = "HumanoidRootPart"}
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "I-enable",
    Default = false,
    Tooltip = "Auto lock walang button",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "I-enable",
    Default = false,
    Tooltip = "Auto putok kapag naka-lock",
})
                ...
                if player ~= LocalPlayer and Module.isAlive(player) then
                    ...
                    if hrp then
                        ...
                        if onScreen then
                            ...
                            local fromPos
                            if Options.TracerPosition.Value == "Taas" then
                                fromPos = Vector2.new(Camera.ViewportSize.X / 2, 0)
                            elseif Options.TracerPosition.Value == "Gitna" then
...
TracerBox:AddDropdown("TracerPosition", {
    Text = "Simula ng Posisyon",
    Values = {"Taas", "Gitna", "Baba"},
    Default = 3,
})
