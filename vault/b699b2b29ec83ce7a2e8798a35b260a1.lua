...
-- Script ID: b699b2b29ec83ce7a2e8798a35b260a1
-- Migrated: 2025-09-11T12:58:37.941Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_6531adbf09efaa7d__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_91c8194e356be26e__"))()
...
Tab:AddParagraph({
    Title = "GODモードステータスGODモードは、スクリプトの読み込み時に自動的に有効になります",
    Content = "シングルプレーヤーで最もよく機能します"
})
