...
-- Script ID: 30b590fcdeb53b56e8e3af4d8fc0e9e4
-- Migrated: 2025-09-11T13:21:02.639Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_b12820deba8055cc__"))()

local Window = Fluent:CreateWindow({
    Title = "ออโต้ฟาร์มและการขาย",
    SubTitle = "",
    TabWidth = 80,
...
local Tab = Window:AddTab({ Title = "หลัก", Icon = "" })
local ShopTab = Window:AddTab({ Title = "ร้านขายของ", Icon = "" })
...
Tab:AddToggle("AutoFarm", {Title = "ออโต้ฟาร์ม", Default = false}):OnChanged(function(value)
...
Tab:AddToggle("AutoSell", {Title = "คำสั่ง Auto Sell", Default = false}):OnChanged(function(value)
...
for _, itemName in ipairs(shopItems) do
    ...
    ShopTab:AddToggle(toggleId, {
        Title = "การซื้ออัตโนมัติ" .. itemName, 
        Default = false
...
ShopTab:AddParagraph({
    Title = "รายการที่กำหนดเอง",
    Content = "เพิ่มรายการของคุณเองเพื่อซื้ออัตโนมัติ"
})
...
ShopTab:AddButton({
    Title = "เพิ่มชื่อไอเท็มของร้านค้า",
    ...
    Callback = function()
        ...
        if customItemName ~= "" and customItemName ~= nil and not customToggles[customItemName] then
            ...
            -- Create the toggle
            ShopTab:AddToggle(toggleId, {
                Title = "การซื้ออัตโนมัติ" .. customItemName,
                Default = false
            }):OnChanged(function(value)
