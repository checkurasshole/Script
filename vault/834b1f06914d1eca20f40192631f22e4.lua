...
-- Script ID: 834b1f06914d1eca20f40192631f22e4
-- Created: 2025-10-19T14:52:15.381Z
-- Source: External API
...
local Tabs = {
    ...
    AutoWalk = Window:AddTab("Zieljagd", "navigation"),
    Collect = Window:AddTab("Geldforderung", "dollar-sign"),
    PrivServer = Window:AddTab("Servermodus", "server"),
...
local ESPGroupBox = Tabs.Main:AddLeftGroupbox("Anzeigeoptionen", "eye")

ESPGroupBox:AddToggle("ESPToggle", {
    Text = "Tier-Marker anzeigen",
    Default = false,
    Callback = function(v)
        espEnabled = v
        if not v then
...
local AnimalGroupBox = Tabs.Main:AddRightGroupbox("Tierfilter", "filter")

AnimalGroupBox:AddDropdown("CommonDropdown", {
    Values = ComboWick.commonAnimals,
    Multi = true,
    Default = 1,
    Text = "Standard Haustiere",
...
local AutoWalkGroupBox = Tabs.AutoWalk:AddLeftGroupbox("Jagdeinstellungen", "navigation")

AutoWalkGroupBox:AddToggle("AutoWalkToggle", {
    Text = "Pet Hunt starten",
    Default = false,
    Callback = function(v)
        autoWalkEnabled = v
        if v then
...
local CollectGroupBox = Tabs.Collect:AddLeftGroupbox("Forderungseinstellungen", "dollar-sign")

CollectGroupBox:AddToggle("SammelnMoneyToggle", {
    Text = "Automatische Forderung",
    Default = false,
    Callback = function(v)
...
local StatusGroupBox = Tabs.Collect:AddRightGroupbox("Status", "activity")
...
local PrivServerGroupBox = Tabs.PrivServer:AddLeftGroupbox("Privater Server", "server")

PrivServerGroupBox:AddLabel({
    Text = "CHARGENBEZEICHNUNG",
    DoesWrap = true,
})

PrivServerGroupBox:AddDivider()

local MenuGroup = Tabs["UI Settings"]:AddLeftGroupbox("Menü", "settings")
