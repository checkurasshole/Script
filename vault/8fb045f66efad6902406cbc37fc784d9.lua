...
-- Script ID: 8fb045f66efad6902406cbc37fc784d9
-- Migrated: 2025-09-11T12:58:36.565Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_0f78bed27a6c5b5c__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_7cbc24324bad3a0c__"))()
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "Achèvement de l'objectif de l'automobile",
    Default = false,
...
CombatSection:AddToggle("AllSkills", {
    Title = "Toutes les compétences Spam",
    Default = false,
    Callback = function(Value)
        pcall(function()
