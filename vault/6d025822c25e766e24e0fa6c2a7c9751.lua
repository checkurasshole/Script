...
-- Script ID: 6d025822c25e766e24e0fa6c2a7c9751
-- Migrated: 2025-09-11T12:58:29.793Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_1b6a12ade276558d__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_7587c8cb57cf6705__"))()
...
CombatSection:AddToggle("AutoSpin", {
    Title = "Giración automática del arma",
    Default = false,
    Callback = function(Value)
        pcall(function()
