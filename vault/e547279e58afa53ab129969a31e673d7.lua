...
-- Created: 2026-01-03T00:53:10.993Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local Tabs = {
        ...
        Info = Window:AddTab("Information et liens", "info")
    }
        
    local validationComplete = false
    local validationSuccess = false
    
    local MainGroup = Tabs.Validation:AddLeftGroupbox("Saisissez une clé API")
    ...
    local LinksGroup = Tabs.Info:AddLeftGroupbox("Liens rapides")
    ...
    local HWIDGroup = Tabs.Info:AddRightGroupbox("Informations HWID")
