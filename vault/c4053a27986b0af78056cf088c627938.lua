...
-- Script ID: c4053a27986b0af78056cf088c627938
-- Created: 2025-10-09T15:01:41.514Z
-- Source: External API
...
local Tabs = {
    Discord = Window:AddTab({ Title = "Joignez-vous à Discord !", Icon = "link" }),
    Main = Window:AddTab({ Title = "Principales", Icon = "home" }),
    Plant = Window:AddTab({ Title = "Plantes", Icon = "leaf" }),
    Seeds = Window:AddTab({ Title = "Graines", Icon = "sprout" }),
    Remove = Window:AddTab({ Title = "Supprimer", Icon = "trash-2" }),
    Shop = Window:AddTab({ Title = "Magasiner", Icon = "shopping-cart" }),
    Events = Window:AddTab({ Title = "Détecteur météorologique", Icon = "zap" }),
...
local EventDetectorToggle = Tabs.Events:AddToggle("EventDetector", {
    Title = "Détecteur météorologique",
    Default = false,
    Callback = function(Value)
...
local PlaceBestBrainrotsButton = Tabs.Main:AddButton({
    Title = "Mettre en place les meilleurs brainrots",
    Callback = function()
        local args = {}
...
local AutoCollectMoneySlider = Tabs.Main:AddSlider("AutoCollectInterval", {
    Title = "Intervalle de collecte automatique (deuxièmes)",
    Default = 5,
    Min = 1,
    Max = 60,
    Rounding = 0,
...
local AutoCollectMoneyToggle = Tabs.Main:AddToggle("AutoCollectMoney", {
    Title = "Recueillir tout l'argent",
    Default = false,
    Callback = function(Value)
...
local SellAllBrainrotsButton = Tabs.Main:AddButton({
    Title = "Vendre tous les brainrots",
    Callback = function()
        local args = {
            [3] = true
        }
...
PlantToggle:OnChanged(function(Value)
    if Value then
        ...
        if isPlanting then
            Fluent:Notify({
                Title = "Déjà en cours d'exécution",
                Duration = 3
            })
            PlantToggle:SetValue(false)
            return
...
local PlatformSlider = Tabs.Shop:AddSlider("PlatformLevel", {
    Title = "Niveau de la plate-forme (1-30)",
    Default = 1,
    Min = 1,
    Max = 30,
    Rounding = 0,
...
local BuyPlatformButton = Tabs.Shop:AddButton({
    Title = "Acheter la plateforme sélectionnée",
    Callback = function()
        local args = {
...
local BuyAllPlatformsButton = Tabs.Shop:AddButton({
    Title = "Acheter toutes les plateformes (1-30)",
    Callback = function()
        for i = 1, 30 do
            local args = {
                [1] = tostring(i)
...
local GearDropdown = Tabs.Shop:AddDropdown("GearSelect", {
    Title = "Sélectionner l'équipement",
...
local AutoBuyGearToggle = Tabs.Shop:AddToggle("AutoBuyGear", {
    Title = "Achat automatique de l'équipement sélectionné",
    Default = false,
    Callback = function(Value)
        autoBuyGear = Value
        if Value then
...
local BuyAllGearsButton = Tabs.Shop:AddButton({
    Title = "Acheter tous les engrenages",
    Callback = function()
...
local AutoBuySeedToggle = Tabs.Shop:AddToggle("AutoBuySeed", {
    Title = "Acheter automatiquement les semences sélectionnées",
    Default = false,
    Callback = function(Value)
        autoBuySeed = Value
        if Value then
...
local BuyAllSeedsButton = Tabs.Shop:AddButton({
    Title = "Acheter toutes les graines",
    Callback = function()
...
Tabs.Discord:AddParagraph({
    Title = "Serveur de discorde",
    Content = "Rejoignez notre communauté Discord pour des mises à jour et du soutien!"
})

Tabs.Discord:AddParagraph({
    Title = "Inviter un lien",
    Content = "https://discord.gg/BUzsQPEY"
})

Tabs.Discord:AddButton({
    Title = "Copier le lien de discorde",
    Callback = function()
