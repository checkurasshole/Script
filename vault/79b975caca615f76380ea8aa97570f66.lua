...
-- Updated: 2026-09-09T02:29:29.262Z
...
MoveBox:AddSlider("se_walk",   { Text = "行走速度", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "减少卡顿", Default = false, Callback = function(v) setAntiLag(v) end })
