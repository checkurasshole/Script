...
-- Script ID: 9ef55e01db14182be52107600374c978
-- Created: 2025-10-27T03:13:24.595Z
-- Source: External API
...
local MapConfigs = {
	{
		Name = "Email Address",
		DisplayName = "Pinakamabilis na  Awtomatikong Kendi",
		Maze = Mazes:WaitForChild("Cornfield2"),
		FastMode = true,
	},
	{
		Name = "Malalakas na kuta",
		DisplayName = "Malalakas na kuta",
...
local MainBox = Tabs.Main:AddLeftGroupbox("Kendi Auto Farm")
...
if not moduleLoaded then
	...
	for i, mapConfig in ipairs(MapConfigs) do
		...
		MainBox:AddToggle(toggleName, {
			...
			Default = false,
			Tooltip = "Sakahan" .. mapConfig.Name,
		})
