-- Script_1754579545700
-- Script ID: c8cae52db35a47489ffc48a77daa52d4
-- Migrated: 2025-09-11T12:58:12.129Z
...
local Rayfield = loadstring(game:HttpGet('__URL_1814cd5d3906d567__'))()
...
local Window = Rayfield:CreateWindow({
    Name = "COMBO_WICK",
    Icon = 12345678901,
    LoadingTitle = "¡Disfrútalo!",
    LoadingSubtitle = "Por COMBO_WICK",
    Theme = "Ocean",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "ComboCrónica",
        FileName = "NPCConfig"
    }
})

local Tab = Window:CreateTab("Principal", nil)
local AmberTab = Window:CreateTab("Colección ámbar", nil)
local UtilityTab = Window:CreateTab("Utilidad", nil)

-- Utility Tab (Anti-Void)
UtilityTab:CreateSection("Antivoide")
UtilityTab:CreateToggle({
    Name = "Activar el antivoid",
    CurrentValue = false,
    Flag = "AntiVoidToggle",
...
UtilityTab:CreateButton({
    Name = "Falso resultado (Telepuerto...",
    Callback = function()
        fakeOut()
    end
})
...
-- Main Tab
Tab:CreateSection("Velocidad de marcha")
Tab:CreateToggle({
    Name = "Activar velocidad de marcha",
    CurrentValue = false,
...
Tab:CreateSlider({
    Name = "Valor de la velocidad de ma...",
    Range = {1, 500},
    Increment = 1,
    Suffix = "speed",
    CurrentValue = 16,
...
Tab:CreateSection("Animal AutoFarm")
Tab:CreateToggle({
    Name = "Habilitar el nombre ESP",
    CurrentValue = false,
    Flag = "ESPNameToggle",
    Callback = function(value)
        toggleESP(value)
...
Tab:CreateToggle({
    Name = "Habilitar el punto culminan...",
    CurrentValue = false,
...
Tab:CreateToggle({
    Name = "Teletransporte a los NPCs d...",
    CurrentValue = false,
...
Tab:CreateSection("Jugador AutoFarm")
Tab:CreateToggle({
    Name = "Teletransportar a los jugad...",
    CurrentValue = false,
    Flag = "TeleportToggle",
    Callback = function(value)
        teleporting = value
...
Tab:CreateToggle({
    Name = "Jugadores de movimiento de ...",
    CurrentValue = true,
...
Tab:CreateToggle({
    Name = "Objetivo todavía jugadores",
    CurrentValue = true,
...
Tab:CreateSlider({
    Name = "Distancia detrás del enemigo",
    Range = {1, 100},
    Increment = 1,
    Suffix = "studs",
    CurrentValue = 5,
...
AmberTab:CreateToggle({
    Name = "Habilitar la colección ámbar",
    CurrentValue = false,
