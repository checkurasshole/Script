...
-- Updated: 2026-09-12T04:11:52.035Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "Huwag Ibenta (rarity)" })
...
local function serverHop(pref)
    ...
    notify(("Hop: %d server ang nahanap"):format(#list))
    local idx = 0
    local conn
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("Walang hit na na-detect sa 25s"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Nabigong makuha ang target"); unlockMove(); return end
            stolen = stolen + 1
