...
-- Script ID: fbb3f27e1daaacdf0b34b011eac9c4e3
-- Created: 2025-10-09T15:01:40.207Z
-- Source: External API
...
local Tabs = {
    Discord = Window:AddTab({ Title = "Присоединяйся к Дискорду!", Icon = "link" }),
    Main = Window:AddTab({ Title = "Главное", Icon = "home" }),
    Plant = Window:AddTab({ Title = "Растения", Icon = "leaf" }),
    Seeds = Window:AddTab({ Title = "Семена", Icon = "sprout" }),
    Remove = Window:AddTab({ Title = "Удалить", Icon = "trash-2" }),
    Shop = Window:AddTab({ Title = "Магазин", Icon = "shopping-cart" }),
    Events = Window:AddTab({ Title = "Детекторы погоды", Icon = "zap" }),
...
local TargetBrainrotDropdown = Tabs.Main:AddDropdown("TargetBrainrot", {
    Title = "Цельный тип мозгового мозга",
...
local PlaceBestBrainrotsButton = Tabs.Main:AddButton({
    Title = "Расположить лучшие мозговые мозги",
    Callback = function()
        local args = {}
...
local AutoCollectMoneySlider = Tabs.Main:AddSlider("AutoCollectInterval", {
    Title = "Интервал автоматического сбора данных (вторые)",
    Default = 5,
    Min = 1,
    Max = 60,
    Rounding = 0,
...
local BuyPlatformButton = Tabs.Shop:AddButton({
    Title = "Покупка выбранной платформы",
    Callback = function()
        local args = {
...
local BuyAllPlatformsButton = Tabs.Shop:AddButton({
    Title = "Покупайте все платформы (1-30)",
    Callback = function()
        for i = 1, 30 do
            local args = {
                [1] = tostring(i)
...
local AutoBuyGearToggle = Tabs.Shop:AddToggle("AutoBuyGear", {
    Title = "Автопокупка выбранной передачи",
    Default = false,
    Callback = function(Value)
        autoBuyGear = Value
        if Value then
...
local AutoBuySeedToggle = Tabs.Shop:AddToggle("AutoBuySeed", {
    Title = "Автопокупка выбранного семенного материала",
    Default = false,
    Callback = function(Value)
        autoBuySeed = Value
        if Value then
...
Tabs.Settings:AddButton({
    Title = "Перезагрузить отслеживание",
    Callback = function()
        PlantingModule.clearOccupiedSpots()
        PlantingModule.plantLimitReached = false
        Fluent:Notify({
...
Tabs.Discord:AddParagraph({
    ...
    Content = "Присоединяйтесь к нашему сообществу дискордов за новостями и поддержкой!"
})

Tabs.Discord:AddParagraph({
    Title = "Приглашать ссылку",
    Content = "https://discord.gg/BUzsQPEY"
})

Tabs.Discord:AddButton({
    Title = "Копировать ссылку Discord",
    Callback = function()
