...
-- Script ID: a032f439ce85252edd5b4511fc081529
-- Migrated: 2025-09-11T12:58:31.094Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_e506d46ceaa38bd6__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_a990c7c33b11973c__"))()
...
Tab:AddParagraph({
    Title = "God Mode Status Der God Mode wird beim Laden des Skripts automatisch aktiviert",
    Content = "Funktioniert am besten im Einzelspieler"
})
...
TeleportSection:AddDropdown("DoorAvoidance", {
    Title = "Abstand zur Türvermeidung",
