...
-- Script ID: 9bac4a4126ffbdafad7ee3e3129b5518
-- Created: 2025-10-09T15:01:46.732Z
-- Source: External API
...
local Tabs = {
    Discord = Window:AddTab({ Title = "Sumali sa Discord!", Icon = "link" }),
    Main = Window:AddTab({ Title = "Main", Icon = "home" }),
    Plant = Window:AddTab({ Title = "Mga Halaman", Icon = "leaf" }),
    Seeds = Window:AddTab({ Title = "Mga buto ng halaman", Icon = "sprout" }),
    Remove = Window:AddTab({ Title = "Tanggalin", Icon = "trash-2" }),
    Shop = Window:AddTab({ Title = "Tindahan", Icon = "shopping-cart" }),
    Events = Window:AddTab({ Title = "Weather Detector", Icon = "zap" }),
    Settings = Window:AddTab({ Title = "Mga Setting", Icon = "settings" })
}
...
local TargetBrainrotDropdown = Tabs.Main:AddDropdown("TargetBrainrot", {
    Title = "Target na Uri ng Brainrot",
...
local PlaceBestBrainrotsButton = Tabs.Main:AddButton({
    Title = "Maglagay ng Pinakamahusay na Brainrots",
    Callback = function()
        local args = {}
...
local AutoCollectMoneySlider = Tabs.Main:AddSlider("AutoCollectInterval", {
    Title = "Auto Collect Interval (Segundo)",
    Default = 5,
    Min = 1,
    Max = 60,
    Rounding = 0,
...
local AutoCollectMoneyToggle = Tabs.Main:AddToggle("AutoCollectMoney", {
    Title = "Kolektahin ang Lahat ng Pera",
    Default = false,
    Callback = function(Value)
...
local SellAllBrainrotsButton = Tabs.Main:AddButton({
    Title = "Ibenta ang Lahat ng Brainrots",
    Callback = function()
        local args = {
            [3] = true
        }
...
local RebirthButton = Tabs.Main:AddButton({
    Title = "Muling Pagsilang Isang beses",
    Callback = function()
        local args = {}
        ReplicatedStorage:WaitForChild("Remotes", 9e9):WaitForChild("Rebirth", 9e9):FireServer(unpack(args))
...
local BuyPlatformButton = Tabs.Shop:AddButton({
    Title = "Bumili ng Napiling Platform",
    Callback = function()
        local args = {
...
local BuyAllPlatformsButton = Tabs.Shop:AddButton({
    Title = "Bilhin ang Lahat ng Mga Platform (1 -30)",
    Callback = function()
        for i = 1, 30 do
            local args = {
                [1] = tostring(i)
...
local AutoBuyGearToggle = Tabs.Shop:AddToggle("AutoBuyGear", {
    Title = "Auto Bilhin Napiling Gear",
    Default = false,
    Callback = function(Value)
        autoBuyGear = Value
        if Value then
...
local BuyAllGearsButton = Tabs.Shop:AddButton({
    Title = "Bumili ng Lahat ng Gears",
    Callback = function()
...
local BuyAllSeedsButton = Tabs.Shop:AddButton({
    Title = "Lahat ng buto ng halaman",
    Callback = function()
...
Tabs.Discord:AddParagraph({
    ...
    Content = "Sumali sa aming komunidad ng Discord para sa mga update at suporta!"
})

Tabs.Discord:AddParagraph({
    Title = "Link ng Imbitasyon",
    Content = "https://discord.gg/BUzsQPEY"
})

Tabs.Discord:AddButton({
    Title = "Kopyahin ang Link ng Discord",
    Callback = function()
