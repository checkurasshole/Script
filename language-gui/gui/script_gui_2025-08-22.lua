...
-- Generated on: 8/22/2025, 11:20:36 AM
...
local scripts = {
    ["English"] = "https://raw.githubusercontent.com/checkurasshole/FARMER/refs/heads/main/Eng",
    ["Spanish"] = "https://v0-supabase-secure-storage.vercel.app/api/script/36596bee90d66bf91d4bd84d581da4ff"
}
...
-- [Rest of the GUI code continues with all the visual elements, animations, etc.]
-- This is the complete GUI implementation with all features
...
local function createLanguageButton(languageName, scriptUrl)
    ...
    button.MouseButton1Click:Connect(function()
        ...
        -- Loading animation and script execution
        spawn(function()
            wait(1.8)
            local success, result = pcall(function()
