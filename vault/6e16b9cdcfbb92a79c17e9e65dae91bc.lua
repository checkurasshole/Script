...
-- Script ID: 6e16b9cdcfbb92a79c17e9e65dae91bc
-- Created: 2025-12-22T16:26:08.932Z
-- Source: External API
-- Auto-generated by Lua Script Vault

-- Main Script
-- Dies lädt das Modul und erstellt die Benutzeroberfläche
...
-- Main Purchases Box
local MainBox = Tabs.Main:AddLeftGroupbox("Einkäufe", "package")
...
-- Manual Purchase Box
local ManualBox = Tabs.Main:AddRightGroupbox("Manuelle Käufe", "edit")
...
ManualBox:AddInput("ManualID", {
    ...
    Finished = true,
    Text = "Artikel-ID",
    Placeholder = "Geben Sie die Artikel-ID ein",
    Callback = function(Value)
