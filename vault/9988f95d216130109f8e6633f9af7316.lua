...
-- Updated: 2026-09-09T02:29:37.352Z
...
MoveBox:AddSlider("se_walk",   { Text = "ความเร็วเดิน", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "ลดแลค", Default = false, Callback = function(v) setAntiLag(v) end })
