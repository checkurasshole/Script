...
-- Script ID: c9ed78d9ab7e3067ce039a4441fc205b
-- Created: 2026-01-03T00:53:13.013Z
-- Source: External API
...
if VaultModule.compareVersions(VaultModule.CONFIG.VERSION, '1.3.2') <= 0 then
    Library:Notify({
        Title = '업데이트 필요',
        Description = '이 버전은 더 이상 지원되지 않습니다. ' .. VaultModule.CONFIG.MIN_VERSION .. ' 버전 이상으로 업데이트하세요',
        Time = 10,
    })
    return {
        success = false,
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    MainGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "링크 복사됨",
                Description = "API 키 링크가 클립보드로 복사되었습니다",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "링크 복사됨",
                Description = "유튜브 채널 링크가 클립보드로 복사되었습니다",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "링크 복사됨",
                Description = "디스코드 서버 링크가 클립보드로 복사되었습니다",
                Time = 2
            })
        end
    })
    ...
    HWIDGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "복사됨",
                Description = "HWID가 클립보드로 복사되었습니다",
                Time = 2
            })
        end
    })
