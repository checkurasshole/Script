...
-- Created: 2025-12-18T07:36:13.654Z
-- Source: External API
...
local Tabs = {
    Respawn = Window:AddTab("자동 리스폰", "refresh-cw"),
    AimAssist = Window:AddTab("AIM Assistant", "star"),
    Visuals = Window:AddTab("시각 자료:", "eye"),
    ["UI Settings"] = Window:AddTab("UI 설정", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("자동 재생 루프")
...
local TracerBox = Tabs.Visuals:AddRightGroupbox("트레이서")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("자동재생", {
    Text = "자동 재생 루프",
    Default = false,
    Tooltip = "사망 시 자동 부활",
})
