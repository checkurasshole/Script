...
-- Script ID: e6e7d19a284d74e83443a0891cae13bd
-- Migrated: 2025-09-11T12:58:32.477Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_54ca6410bca0bf28__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_8da9b509961b8a66__"))()

local Window = Fluent:CreateWindow({
    Title = "COMBO_WICK",
    SubTitle = "Наслаждайтесь!",
    TabWidth = 120,
...
Tab:AddParagraph({
    Title = "Режим состояния Бога автоматически включен при загрузке скрипта",
    Content = "Лучшая работа в едином игроке"
})
...
TeleportSection:AddToggle("TargetPart", {
    Title = "Целевая головка (OFF = Ноги)",
    Default = true,
    Callback = function(Value)
        pcall(function()
            TargetHead = Value
...
TeleportSection:AddDropdown("DoorAvoidance", {
    Title = "Расстояние между дверями",
...
TeleportSection:AddButton({
    Title = "Обновить целевые показатели",
    Callback = function()
        pcall(function()
            doorCache = {}
            targetCache = {}
...
CombatSection:AddToggle("AutoSpin", {
    Title = "Автомобильный скачок оружия",
    Default = false,
    Callback = function(Value)
        pcall(function()
