...
-- Created: 2025-12-18T07:36:14.145Z
-- Source: External API
...
local Tabs = {
    Respawn = Window:AddTab("Tự Động Hồi Sinh", "refresh-cw"),
    AimAssist = Window:AddTab("Trợ lý mục tiêu", "star"),
    Visuals = Window:AddTab("Hình", "eye"),
    ["UI Settings"] = Window:AddTab("Cài đặt giao diện người dùng", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("Vòng lặp Phát Tự động")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("Phiên bản 1 - Máy tính thủ công")
local AimbotV2Box = Tabs.AimAssist:AddRightGroupbox("Phiên bản 2 - Tự động")
local TriggerBox = Tabs.AimAssist:AddLeftGroupbox("Chụp tự động")
local ESPBox = Tabs.Visuals:AddLeftGroupbox("ESP của người chơi")
local TracerBox = Tabs.Visuals:AddRightGroupbox("Chất theo dõi")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("Tự động chạy", {
    Text = "Vòng lặp Phát Tự động",
    Default = false,
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "Bật",
    Default = false,
    Tooltip = "Nhấn giữ chuột phải để khóa",
})
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "Bật",
    Default = false,
    Tooltip = "Nút tự động khóa không",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "Bật",
    Default = false,
    Tooltip = "Tự động chụp khi khóa",
})

TriggerBox:AddSlider("Trì hoãn kích hoạt", {
    Text = "Độ trễ (ms)",
    Default = 50,
    Min = 0,
    Max = 500,
...
TracerBox:AddToggle("Chất theo dõi", {
    Text = "Bật",
    Default = false,
})
