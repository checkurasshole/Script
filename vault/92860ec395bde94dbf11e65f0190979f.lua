...
-- Script ID: 92860ec395bde94dbf11e65f0190979f
-- Created: 2025-10-18T02:37:56.482Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("Informações HWID")
    ...
    LeftGroup:AddLabel({
        Text = "O acesso requer validação",
        DoesWrap = true,
    })
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("Links rápidos")
