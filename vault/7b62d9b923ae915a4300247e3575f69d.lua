...
-- Script ID: 7b62d9b923ae915a4300247e3575f69d
-- Created: 2025-10-19T14:54:40.659Z
-- Source: External API
...
local Tabs = {
    ...
    AutoWalk = Window:AddTab("Chasse à la cible", "navigation"),
    Collect = Window:AddTab("Montant réclamé", "dollar-sign"),
    PrivServer = Window:AddTab("Mode serveur", "server"),
...
local ESPGroupBox = Tabs.Main:AddLeftGroupbox("Options d'affichage", "eye")

ESPGroupBox:AddToggle("ESPToggle", {
    Text = "Afficher les marqueurs pour animaux de compagnie",
    Default = false,
    Callback = function(v)
        espEnabled = v
        if not v then
...
ESPGroupBox:AddToggle("TracerToggle", {
    Text = "Afficher les lignes d'orientation",
    Default = false,
    Callback = function(v)
        tracerEnabled = v
        if not v then
...
local AnimalGroupBox = Tabs.Main:AddRightGroupbox("Filtre pour animaux de compagnie", "filter")

AnimalGroupBox:AddDropdown("CommonDropdown", {
    Values = ComboWick.commonAnimals,
    Multi = true,
    Default = 1,
    Text = "Animaux de compagnie standard",
...
AnimalGroupBox:AddDropdown("AdminDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "Admin/OG Animaux de compagnie",
    Callback = function(Value)
...
AnimalGroupBox:AddDropdown("BrainrotGodDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "BrainrotDieu Animaux de compagnie",
    Searchable = true,
    Callback = function(Value)
...
AnimalGroupBox:AddDropdown("SecretDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "Animaux de compagnie secrets",
    Searchable = true,
    Callback = function(Value)
...
local AutoWalkGroupBox = Tabs.AutoWalk:AddLeftGroupbox("Paramètres de la chasse", "navigation")

AutoWalkGroupBox:AddToggle("AutoWalkToggle", {
    Text = "Lancer la chasse aux animaux de compagnie",
    Default = false,
    Callback = function(v)
        autoWalkEnabled = v
        if v then
...
local CollectGroupBox = Tabs.Collect:AddLeftGroupbox("Paramètres de la réclamation", "dollar-sign")

CollectGroupBox:AddToggle("CollectMoneyToggle", {
    Text = "Réclamation automatique",
    Default = false,
    Callback = function(v)
...
local StatusGroupBox = Tabs.Collect:AddRightGroupbox("État", "activity")
...
local PrivServerGroupBox = Tabs.PrivServer:AddLeftGroupbox("Serveur privé", "server")
