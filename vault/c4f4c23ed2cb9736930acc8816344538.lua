...
-- Updated: 2026-09-09T02:29:15.888Z
...
MoveBox:AddSlider("se_walk",   { Text = "Velocidade de Caminhada", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Reduzir Lag", Default = false, Callback = function(v) setAntiLag(v) end })
