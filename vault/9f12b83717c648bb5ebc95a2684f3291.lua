...
-- Created: 2025-12-31T21:50:10.837Z
-- Source: External API
-- Auto-generated by Lua Script Vault

local CoreGui = game:GetService("CoreGui")
local guiName = "ShayaAsian"
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local Tabs = {
        ...
        Info = Window:AddTab("Username or email address *", "info")
    }
    ...
    local LinksGroup = Tabs.Info:AddLeftGroupbox("Mabilis na mga Link")
