...
-- Script ID: 068983fa45550f145578178f8d83191e
-- Updated: 2025-10-01T20:23:50.079Z
...
local function handleBuildStatus(status, data)
    ...
    elseif status == "cancelled" then
        WindUI:Notify({
            Title = "Tòa nhà đã bị hủy",
            Content = "Dừng lại ở" .. data.wallNumber,
            Icon = "x-circle",
            Duration = 3
        })
    elseif status == "placement_failed" then
        WindUI:Notify({
            Title = "⚠️ VỊ TRÍ KHÔNG THÀNH CÔNG",
            Content = "Tường" .. data.wallNumber,
            Icon = "alert-triangle",
            Duration = 10
        })
    elseif status == "walls_not_appearing" then
        WindUI:Notify({
            Title = "⚠️ TƯỜNG KHÔNG XUẤT HIỆN",
            Content = "",
            Icon = "alert-triangle",
            Duration = 10
        })
...
local MainTab = Window:Tab({ Title = "Nhiệm vụ Chính", Icon = "zap" })
local DiamondFarmTab = Window:Tab({ Title = "Diamond Farm", Icon = "gem" })
local CollectorTab = Window:Tab({ Title = "Bộ sưu tập vật phẩm", Icon = "package" })
local PivotTab = Window:Tab({ Title = "MainFire", Icon = "move" })
local CombatTab = Window:Tab({ Title = "Hệ thống chiến đấu", Icon = "sword" })
local CookingTab = Window:Tab({ Title = "Nấu nướng", Icon = "flame" })
local VisualTab = Window:Tab({ Title = "Sử dụng các công cụ trực quan", Icon = "eye" })

-- WINDUI TABS (BELOW)
local LogWallTab = Window:Tab({ Title = "Tường nhật ký", Icon = "shield" })
local PlantHouseTab = Window:Tab({ Title = "Cây/Nhà", Icon = "home" })
local ConfigTab = Window:Tab({ Title = "Cấu hình", Icon = "save" })
...
MainTab:Toggle({
    Title = "Mở khóa bản đồ + Nhận trẻ em",
    Desc = "",
    Value = false,
...
diamondFarmToggle = DiamondFarmTab:Toggle({  -- Store the toggle reference
    ...
    Callback = function(Value)
        ...
        if Value then
            ...
            if success then
                WindUI:Notify({
                    Title = "Trang trại kim cương đã được tải",
                    Content = "Đã kích hoạt tập lệnh thành công",
                    Icon = "gem",
                    Duration = 3
                })
            else
                WindUI:Notify({
                    Title = "Không thể Tải",
                    Content = "Không thể tải tập lệnh trang trại kim cương",
                    Icon = "x-circle",
                    Duration = 5
                })
            end
            ...
            WindUI:Notify({
                Title = "Trang trại kim cương bị vô hiệu hóa",
                Content = "Tắt - tập lệnh có thể vẫn đang chạy",
                Icon = "info",
                Duration = 2
            })
        end
...
local PlayerDropdown = CollectorTab:Dropdown({
    Title = "Thu thập vật phẩm cho người chơi",
    Desc = "",
    ...
    Callback = function(Value)
        ...
        WindUI:Notify({
            Title = "Người chơi mục tiêu đã thay đổi",
            Content = "Các mục sẽ được thu thập để" .. Value,
            Duration = 2
        })
    end
})
...
CollectorTab:Button({
    Title = "Thu thập các mục đã chọn",
    Desc = "",
    Icon = "download",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
        if selectedItem then
            ...
            WindUI:Notify({
                Title = "Không có sự lựa chọn nào",
                Content = "Trước tiên, hãy chọn {type}.",
                Duration = 2
            })
        end
    end
...
CollectorTab:Toggle({
    Title = "Phát hiện ngực kim cương",
...
CollectorTab:Toggle({
    Title = "Tự động cướp vật phẩm mới",
...
PivotTab:Button({
    Title = "Dịch chuyển tức thời đến vị trí đã chọn",
    Desc = "",
    Icon = "map-pin",
    Callback = function()
...
PivotTab:Toggle({
    Title = "Phân tán các vật dụng xung quanh",
    Desc = "",
    Value = true,
    Callback = function(Value)
...
-- =====================
CombatTab:Button({
    Title = "Tự động phát hiện vũ khí",
...
CombatTab:Button({
    Title = "Ngay lập tức TẤT CẢ lời nhắc",
    Desc = "",
    Icon = "zap",
    Callback = function()
        local modified = 0
...
CookingTab:Toggle({
    Title = "Mang theo thức ăn sau khi nấu",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
VisualTab:Toggle({
    Title = "Làm nổi bật tên người chơi",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
VisualTab:Button({
    Title = "Sao chép tập lệnh dịch chuyển tức thời trò chơi",
    Desc = "",
    Icon = "copy",
    Callback = function()
...
LogWallTab:Button({
    Title = "CHẾ ĐỘ ⚠️ BETA - MONG ĐỢI LỖI",
    Desc = "",
    Icon = "alert-triangle",
    Color = Color3.fromHex("#ff4830"),
    Callback = function() end
...
resourceButton = LogWallTab:Button({
    Title = "Tài nguyên Có sẵn",
    Desc = "",
    Icon = "package",
    Callback = function()
        updateLogWallResourceDisplay()
        WindUI:Notify({
            Title = "Đã cập nhật tài nguyên",
            Content = "",
            Icon = "refresh-cw",
            Duration = 2
        })
...
radiusSlider = LogWallTab:Slider({
    Title = "Bán kính của một vòng tròn",
    Desc = "",
    Value = {
        Min = 3,
        Max = 500,
...
maxZoomSlider = LogWallTab:Slider({
    Title = "Khoảng cách thu phóng tối đa",
    Desc = "",
    Value = {
        Min = 50,
        Max = 2000,
...
LogWallTab:Button({
    Title = "Xóa bản xem trước",
    Desc = "",
    Icon = "trash-2",
    Callback = function()
        LogWallBuilder:ClearPreview()
        WindUI:Notify({
            Title = "Đã xóa bản xem trước",
            Content = "",
            Icon = "trash-2",
            Duration = 2
        })
...
LogWallTab:Button({
    Title = "XÂY DỰNG VÒNG TRÒN XUNG QUANH TRẠI",
    Desc = "",
    Icon = "zap",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
...
continueButton = LogWallTab:Button({
    ...
    Callback = function()
        if LogWallBuilder:ContinueBuilding() then
            WindUI:Notify({
                Title = "Tòa nhà đã được khôi phục",
                Content = "",
                Icon = "play",
                Duration = 2
            })
...
LogWallTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Tòa nhà đã ngừng hoạt động",
            Content = "",
            Icon = "square",
            Duration = 2
        })
...
plantResourceButton = PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Đã cập nhật tài nguyên",
            Content = "Số lượng mặt hàng đã được làm mới",
            Icon = "refresh-cw",
            Duration = 2
        })
    end
...
PlantHouseTab:Button({
    Title = "Sử dụng vị trí người chơi",
    Desc = "",
    Icon = "map-pin",
    Callback = function()
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            ...
            WindUI:Notify({
                ...
                Content = "Đặt thành vị trí người chơi",
                Icon = "map-pin",
                Duration = 2
            })
        end
...
PlantHouseTab:Button({
    ...
    Callback = function()
        if PlantHouseBuilder.config.isBuilding then
            WindUI:Notify({
                Title = "Đã xây dựng",
                Content = "Vui lòng đợi bản dựng hiện tại kết thúc",
                Icon = "alert-circle",
                Duration = 3
            })
            return
        ...
        if #allPoints > 0 then
            ...
            if available < #allPoints then
                WindUI:Notify({
                    ...
                    Content = "Về Nhu cầu" .. (#allPoints - available) .. " more items",
                    Icon = "x-circle",
                    Duration = 5
                })
                return
            ...
            WindUI:Notify({
                Title = "Bắt đầu xây dựng!",
                Content = "Xây dựng" .. #allPoints .. " blocks",
                Icon = "hammer",
                Duration = 3
            })
        else
            WindUI:Notify({
                Title = "Không có gì được chọn",
                Content = "Vui lòng chọn hình dạng cây hoặc loại nhà",
                Icon = "alert-triangle",
                Duration = 3
            })
        end
...
PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Tòa nhà đã ngừng hoạt động",
            Content = "Đã hủy tất cả các bản dựng đang chờ xử",
            Icon = "square",
            Duration = 2
        })
    end
...
ConfigTab:Button({
    ...
    Callback = function()
        if configNameInput == "" then
            WindUI:Notify({
                Title = "Lỗi",
                Content = "Nhập tên cấu hình trước",
                Icon = "alert-circle",
                Duration = 3
            })
            return
...
ConfigTab:Button({
    Title = "Làm mới danh sách cấu hình",
...
ConfigTab:Button({
    Title = "Tải và thực thi (Tường nhật ký)",
...
autoLoadToggle = ConfigTab:Toggle({
    Title = "Tự động tải khi khởi động",
...
autoLoadConfigDropdown = ConfigTab:Dropdown({
    ...
    Callback = function(v)
        ...
        saveAutoLoadSettings()
        WindUI:Notify({
            Title = "Đặt cấu hình tải tự động",
            Content = v,
            Icon = "check-circle",
            Duration = 2
        })
...
WindUI:Notify({
    Title = "Đã tải Trung tâm công cụ tối ưu!",
    Content = "Tất cả các tính năng đã sẵn sàng",
    Icon = "check-circle",
    Duration = 3
})
