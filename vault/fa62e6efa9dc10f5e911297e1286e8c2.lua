...
-- Script ID: fa62e6efa9dc10f5e911297e1286e8c2
-- Created: 2025-10-18T02:37:55.453Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("Renseignements sur le HWID")
    ...
    LeftGroup:AddLabel({
        Text = "L'accès nécessite une validation",
        DoesWrap = true,
    })
    ...
    LeftGroup:AddButton({
        Text = "Copier le code HWID",
        Func = function()
            setclipboard(clientId)
            Library:Notify({
                Title = "Copie d'une copie",
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("Liens rapides")
    
    RightGroup:AddButton({
        Text = "Cliquez ici pour obtenir le lien clé",
        Func = function()
