...
-- Updated: 2026-09-09T02:29:31.999Z
...
MoveBox:AddSlider("se_walk",   { Text = "Gehgeschwindigkeit", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Lag reduzieren", Default = false, Callback = function(v) setAntiLag(v) end })
