...
-- Script ID: 447fed65c7aac4df2af8577b0c54fc65
-- Updated: 2025-10-01T20:20:23.028Z
...
local function handleBuildStatus(status, data)
    ...
    elseif status == "cancelled" then
        WindUI:Notify({
            Title = "Здание снято",
            Content = "Остановился на" .. data.wallNumber,
            Icon = "x-circle",
            Duration = 3
        })
    elseif status == "placement_failed" then
        WindUI:Notify({
            ...
            Content = "Стена" .. data.wallNumber,
            Icon = "alert-triangle",
            Duration = 10
        })
    elseif status == "walls_not_appearing" then
        WindUI:Notify({
            Title = "▪ ВОЛЫ НЕ ДЕЙСТВУЮЩИЕ",
            Content = "",
            Icon = "alert-triangle",
            Duration = 10
        })
...
local MainTab = Window:Tab({ Title = "Главный запрос", Icon = "zap" })
local DiamondFarmTab = Window:Tab({ Title = "Алмазная ферма", Icon = "gem" })
local CollectorTab = Window:Tab({ Title = "Коллекционер", Icon = "package" })
local PivotTab = Window:Tab({ Title = "MainFire", Icon = "move" })
local CombatTab = Window:Tab({ Title = "Боевая система", Icon = "sword" })
local CookingTab = Window:Tab({ Title = "Готовка и еда", Icon = "flame" })
local VisualTab = Window:Tab({ Title = "Визуальные средства", Icon = "eye" })

-- WINDUI TABS (BELOW)
local LogWallTab = Window:Tab({ Title = "Журнальные стенки", Icon = "shield" })
local PlantHouseTab = Window:Tab({ Title = "Растения/дома", Icon = "home" })
local ConfigTab = Window:Tab({ Title = "Конфиг", Icon = "save" })
local SettingsTab = Window:Tab({ Title = "Параметры", Icon = "settings" })
...
MainTab:Toggle({
    Title = "Разблокировать карту + получить детей",
    Desc = "",
    Value = false,
...
MainTab:Dropdown({
    Title = "Заниматься воспитанием детей",
    Desc = "",
...
DiamondFarmTab:Button({
    Title = "Система алмазодобывающих хозяйств",
    Desc = "",
    Icon = "info",
    Callback = function() end
})
...
diamondFarmToggle = DiamondFarmTab:Toggle({  -- Store the toggle reference
    Title = "Разрешить алмазную ферму",
    ...
    Callback = function(Value)
        ...
        if Value then
            ...
            if success then
                WindUI:Notify({
                    Title = "Алмазная ферма",
                    Content = "Скрипт активирован успешно",
                    Icon = "gem",
                    Duration = 3
                })
            else
                WindUI:Notify({
                    ...
                    Content = "Невозможно загрузить скрипт алмазной фермы",
                    Icon = "x-circle",
                    Duration = 5
                })
            end
            ...
            WindUI:Notify({
                Title = "Алмазная ферма &lt; &lt; Инвалид &gt; &gt;",
                Content = "Скриншот, возможно, все еще работает",
                Icon = "info",
                Duration = 2
            })
        end
...
local PlayerDropdown = CollectorTab:Dropdown({
    ...
    Callback = function(Value)
        ...
        WindUI:Notify({
            Title = "Целевый игрок изменён",
            Content = "Пункты будут собраны по адресу:" .. Value,
            Duration = 2
        })
    end
})
...
CollectorTab:Button({
    Title = "Соберите отдельные элементы",
    Desc = "",
    Icon = "download",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
        if selectedItem then
            ...
            WindUI:Notify({
                Title = "Выбор не сделан",
                Content = "Выберите первый тип",
                Duration = 2
            })
        end
    end
...
CollectorTab:Button({
    Title = "Откройте все грудные клетки",
    Desc = "",
    Icon = "box",
    Callback = function()
...
CollectorTab:Toggle({
    Title = "Обнаружение бриллиантов в грудной клетке",
...
CollectorTab:Toggle({
    Title = "Автозагрузить новые элементы",
...
CollectorTab:Toggle({
    Title = "Автоконтейнеры для сбора данных",
...
PivotTab:Button({
    Title = "Телепорт в выбранное положение",
    Desc = "",
    Icon = "map-pin",
    Callback = function()
...
PivotTab:Slider({
    Title = "Не разбрасывайте предметы",
    Desc = "",
    Value = {
        Min = 1,
        Max = 15,
...
-- =====================
CombatTab:Button({
    Title = "Обнаружение автоматического оружия",
...
CombatTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Изменено",
            Content = "Установить" .. modified .. " prompts to instant",
            Duration = 2
        })
    end
})
...
-- =====================
CookingTab:Button({
    Title = "Управление продовольственным снабжением",
    Desc = "",
    Icon = "info",
    Callback = function() end
})
...
CookingTab:Dropdown({
    Title = "Продовольствие для самостоятельной еды",
    Desc = "",
...
CookingTab:Toggle({
    Title = "Принесите еду после повара",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
-- =====================
VisualTab:Button({
    Title = "Визуальные усовершенствования",
    Desc = "",
    Icon = "info",
    Callback = function() end
})
...
VisualTab:Button({
    Title = "Копировать скрипт игры Teleport",
    Desc = "",
    Icon = "copy",
    Callback = function()
...
LogWallTab:Button({
    Title = "▪ БЕТА МОДЕ - ПРЕДСТОЯЩИЕ ВЕЩЕСТВА",
    Desc = "",
    Icon = "alert-triangle",
    Color = Color3.fromHex("#ff4830"),
    Callback = function() end
...
resourceButton = LogWallTab:Button({
    Title = "Имеющиеся ресурсы",
    Desc = "",
    Icon = "package",
    Callback = function()
        updateLogWallResourceDisplay()
        WindUI:Notify({
            Title = "Обновленные данные о ресурсах",
            Content = "",
            Icon = "refresh-cw",
            Duration = 2
        })
...
maxZoomSlider = LogWallTab:Slider({
    Title = "Максимальное расстояние увеличения",
    Desc = "",
    Value = {
        Min = 50,
        Max = 2000,
...
LogWallTab:Button({
    Title = "Очистить просмотр",
    Desc = "",
    Icon = "trash-2",
    Callback = function()
        LogWallBuilder:ClearPreview()
        WindUI:Notify({
            Title = "Просмотр очищен",
            Content = "",
            Icon = "trash-2",
            Duration = 2
        })
...
LogWallTab:Button({
    Title = "РУКОВОДЯЩИЙ РУКОВОДЯЩИЙ КОРОЛЕВСТВА",
    Desc = "",
    Icon = "zap",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
...
continueButton = LogWallTab:Button({
    Title = "Продолжать строительство",
    Desc = "",
    Icon = "play",
...
plantResourceButton = PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Обновленные данные о ресурсах",
            Content = "Освежено количество товаров",
            Icon = "refresh-cw",
            Duration = 2
        })
    end
...
PlantHouseTab:Button({
    Title = "Использовать позицию игрока",
    Desc = "",
    Icon = "map-pin",
    Callback = function()
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            ...
            WindUI:Notify({
                Title = "Обновленная позиция",
                Content = "Займите позицию игрока",
                Icon = "map-pin",
                Duration = 2
            })
        end
...
PlantHouseTab:Button({
    ...
    Callback = function()
        if PlantHouseBuilder.config.isBuilding then
            WindUI:Notify({
                Title = "Уже строительство",
                Content = "Пожалуйста, подождите, пока будет завершено текущее строительство.",
                Icon = "alert-circle",
                Duration = 3
            })
            return
        ...
        if #allPoints > 0 then
            ...
            if available < #allPoints then
                WindUI:Notify({
                    Title = "Хватит вещей!",
                    Content = "Необходимость" .. (#allPoints - available) .. " more items",
                    Icon = "x-circle",
                    Duration = 5
                })
                return
            ...
            WindUI:Notify({
                Title = "Здание стартовало!",
                Content = "Здание" .. #allPoints .. " blocks",
                Icon = "hammer",
                Duration = 3
            })
        else
            WindUI:Notify({
                Title = "Ничего выбранного",
                Content = "Выберите форму растения или тип дома",
                Icon = "alert-triangle",
                Duration = 3
            })
        end
...
PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = ":: Остановка здания",
            Content = "Все находящиеся на рассмотрении здания аннулированы",
            Icon = "square",
            Duration = 2
        })
    end
...
ConfigTab:Button({
    Title = "Создать новую конфигурию",
    ...
    Callback = function()
        if configNameInput == "" then
            WindUI:Notify({
                Title = "Ошибка",
                Content = "Введите сначала название conig",
                Icon = "alert-circle",
                Duration = 3
            })
            return
...
ConfigTab:Button({
    Title = "Сохранить текущую конфигурию",
...
ConfigTab:Button({
    Title = "Загрузить & выполнение (ложные стенки)",
    ...
    Callback = function()
        ...
        if not success then
            ...
            WindUI:Notify({
                Title = "Выполнить стенки журнала",
                Content = selectedConfig,
                Icon = "zap",
                Duration = 2
            })
...
autoLoadToggle = ConfigTab:Toggle({
    Title = "Автозагрузка при запуске",
...
SettingsTab:Input({
    ...
    Callback = function(Value)
        ...
        if numValue and numValue >= 0 and numValue <= 1000 then
            ...
            WindUI:Notify({
                Title = "Предельный предел Большого Трея",
...
WindUI:Notify({
    Title = "Загрузить аппаратный узел!",
    Content = "Все параметры готовы",
    Icon = "check-circle",
    Duration = 3
})
