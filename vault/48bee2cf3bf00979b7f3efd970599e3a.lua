-- Translated Script (Spanish)
-- Script ID: 48bee2cf3bf00979b7f3efd970599e3a
-- Migrated: 2025-09-11T12:58:21.749Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_77f4d261625e61d3__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_b09671c051f812cf__"))()
...
Tab:AddParagraph({
    Title = "Modo Dios Estado El Modo Dios se activa automáticamente en la carga de scripts",
...
local velocityHandlerName = "VelocidadHandler_" .. math.random(1000, 9999)
...
TeleportSection:AddToggle("TargetPart", {
    Title = "Cabeza de Destino (OFF = Piernas)",
    Default = true,
    Callback = function(Value)
        pcall(function()
            TargetHead = Value
...
TeleportSection:AddSlider("HeightOffset", {
    Title = "Altura por encima de BOT",
...
TeleportSection:AddDropdown("DoorAvoidance", {
    Title = "Distancia de evitación de puerta",
...
TeleportSection:AddButton({
    Title = "Actualizar los objetivos",
    Callback = function()
        pcall(function()
            doorCache = {}
            targetCache = {}
