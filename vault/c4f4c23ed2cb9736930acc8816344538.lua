...
-- Updated: 2026-09-12T04:11:20.739Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "Não vender (raridades)" })
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("Nenhum golpe detectado em 25s"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Falha ao pegar o alvo"); unlockMove(); return end
            stolen = stolen + 1
