...
-- Script ID: 853ff162a800f0f2ee958c33c97e795f
-- Migrated: 2025-09-11T13:20:57.554Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_27e5d9b4ab0ee8b8__"))()
...
local Tab = Window:AddTab({ Title = "Haupt", Icon = "" })
...
Tab:AddToggle("AutoFarm", {Title = "Autofarm", Default = false}):OnChanged(function(value)
...
Tab:AddToggle("AutoSell", {Title = "Automatischer Verkauf", Default = false}):OnChanged(function(value)
...
for _, itemName in ipairs(shopItems) do
    ...
    ShopTab:AddToggle(toggleId, {
        Title = "Automatischer Kauf" .. itemName, 
        Default = false
...
ShopTab:AddParagraph({
    Title = "Benutzerdefinierte Artikel",
    Content = "Fügen Sie Ihre eigenen Artikel zum automatischen Kauf hinzu"
})
...
ShopTab:AddButton({
    Title = "Shop-Artikelname hinzufügen",
    ...
    Callback = function()
        ...
        if customItemName ~= "" and customItemName ~= nil and not customToggles[customItemName] then
            ...
            -- Create the toggle
            ShopTab:AddToggle(toggleId, {
                Title = "Automatischer Kauf" .. customItemName,
                Default = false
            }):OnChanged(function(value)
