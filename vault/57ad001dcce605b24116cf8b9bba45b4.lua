...
-- Script ID: 57ad001dcce605b24116cf8b9bba45b4
-- Created: 2025-12-31T11:15:29.929Z
-- Source: External API
...
if not versionValid then
    ...
    return {
        success = false,
        error = "fallo_en_la_comprobación_de_la_versión",
...
if not whitelisted or errorType == "acceso_denegado" or errorType == "detección_de_alteración" or errorType == "clave_expirada" then
    ...
    if validationSuccess then
        ...
        if whitelisted then
            ...
            return {
                success = false,
                error = "no_autorizado_después_de_la_validación"
            }
        end
    else
        return {
