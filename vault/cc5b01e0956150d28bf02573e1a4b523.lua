...
-- Script ID: cc5b01e0956150d28bf02573e1a4b523
-- Created: 2025-10-19T14:54:39.526Z
-- Source: External API
...
local Tabs = {
    ...
    Collect = Window:AddTab("Money Claim", "dollar-sign"),
    PrivServer = Window:AddTab("Server Mode", "server"),
...
local ESPGroupBox = Tabs.Main:AddLeftGroupbox("Display Options", "eye")

ESPGroupBox:AddToggle("ESPToggle", {
    Text = "Show Pet Markers",
    Default = false,
    Callback = function(v)
        espEnabled = v
        if not v then
...
local AnimalGroupBox = Tabs.Main:AddRightGroupbox("Pet Filter", "filter")
...
local AutoWalkGroupBox = Tabs.AutoWalk:AddLeftGroupbox("Hunt Settings", "navigation")
...
local CollectGroupBox = Tabs.Collect:AddLeftGroupbox("Claim Settings", "dollar-sign")
...
local PrivServerGroupBox = Tabs.PrivServer:AddLeftGroupbox("Private Server", "server")
