-- Script_1754579565259
-- Script ID: 376e4d04f3b4d11c1b041b7360bc9677
-- Migrated: 2025-09-11T12:58:12.789Z
...
local Rayfield = loadstring(game:HttpGet('__URL_61f390eb21e6fc31__'))()
...
local Window = Rayfield:CreateWindow({
    Name = "_COMBO WICK",
    Icon = 12345678901,
    LoadingTitle = "Amusez-vous bien !",
    LoadingSubtitle = "Par COMBO_WICK",
    Theme = "Ocean",
    ConfigurationSaving = {
        Enabled = true,
        FolderName = "ComboChronique",
        FileName = "NPCConfig"
    }
})

local Tab = Window:CreateTab("Principales", nil)
local AmberTab = Window:CreateTab("Collection Amber", nil)
local UtilityTab = Window:CreateTab("Utilitaire", nil)

-- Utility Tab (Anti-Void)
UtilityTab:CreateSection("Anti-Voïde")
UtilityTab:CreateToggle({
    Name = "Activer l'anti-void",
    CurrentValue = false,
    Flag = "AntiVoidToggle",
...
UtilityTab:CreateButton({
    Name = "Faux sorts (téléporter au-d...",
    Callback = function()
        fakeOut()
    end
})
...
-- Main Tab
Tab:CreateSection("Vitesse de marche")
Tab:CreateToggle({
    Name = "Activer la vitesse de marche",
    CurrentValue = false,
...
Tab:CreateSection("Auto-Farm d'animaux")
Tab:CreateToggle({
    Name = "Activer le nom ESP",
    CurrentValue = false,
    Flag = "ESPNameToggle",
    Callback = function(value)
        toggleESP(value)
...
Tab:CreateToggle({
    Name = "Téléporter aux PNC de la ch...",
    CurrentValue = false,
...
Tab:CreateSection("Lecteur AutoFarm")
Tab:CreateToggle({
    Name = "Téléporter aux joueurs",
    CurrentValue = false,
    Flag = "TeleportToggle",
    Callback = function(value)
        teleporting = value
...
Tab:CreateToggle({
    Name = "Lecteurs de déplacement de ...",
    CurrentValue = true,
...
Tab:CreateToggle({
    Name = "Cibler les joueurs encore",
    CurrentValue = true,
...
Tab:CreateSlider({
    Name = "Distance derrière l'ennemi",
    Range = {1, 100},
    Increment = 1,
    Suffix = "studs",
    CurrentValue = 5,
...
AmberTab:CreateSection("Fourrure auto ambre")
AmberTab:CreateToggle({
    Name = "Activer la collection Amber",
    CurrentValue = false,
