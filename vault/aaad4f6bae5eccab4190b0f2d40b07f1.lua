...
-- Script ID: aaad4f6bae5eccab4190b0f2d40b07f1
-- Migrated: 2025-09-11T12:58:22.382Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_bacadd8911ba14f9__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_bcd95b49a53988c8__"))()
...
ScreenGui.Name = "Botón de Activación/Desactivación de la GUI"
...
Tab:AddParagraph({
    Title = "Estado de Modo Divino El Modo Divino se activa automáticamente al cargar el s...",
    Content = "Funciona mejor en Jugador Único."
})
...
local velocityHandlerName = "Manejador de Velocidad_" .. math.random(1000, 9999)
local gyroHandlerName = "Manejador de Giro_" .. math.random(1000, 9999)
local mfly1, mfly2
...
TeleportSection:AddToggle("AutoTeleport", {
    Title = "Modo Automático de Teletransporte",
    Default = false,
...
TeleportSection:AddToggle("TargetPart", {
    Title = "Targeteado Cabeza (OFF = Piernas)",
    Default = true,
    Callback = function(Value)
        pcall(function()
            TargetHead = Value
...
TeleportSection:AddDropdown("DoorAvoidance", {
    Title = "Cargando Distancia de Evitación de Puerta",
...
CombatSection:AddToggle("AutoSpin", {
    Title = "Modo Giratorio Automático",
    Default = false,
    Callback = function(Value)
        pcall(function()
