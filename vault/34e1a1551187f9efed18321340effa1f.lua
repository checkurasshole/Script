...
-- Script ID: 34e1a1551187f9efed18321340effa1f
-- Created: 2025-12-31T16:39:04.287Z
-- Source: External API
...
if not versionValid then
    ...
    return {
        success = false,
        error = "kiểm_tra_phien_ban_that_bai",
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local Tabs = {
        ...
        Info = Window:AddTab("Thông tin & Liên kết", "info")
    }
        
    local validationComplete = false
    local validationSuccess = false
    
    local MainGroup = Tabs.Validation:AddLeftGroupbox("Nhập khóa xác thực")
    ...
    MainGroup:AddInput("KeyInput", {
        ...
        Text = "Nhập khóa",
        Placeholder = "Dán khóa xác thực vào đây...",
    ...
    if validationSuccess then
        ...
        if whitelisted then
            ...
            return {
                success = false,
                error = "không_duoc_phep_sau_xac_thuc"
            }
        end
    else
        return {
            success = false,
            error = "xac_thuc_bi_huy"
        }
    end
end
