...
-- Script ID: 43c8abe3a398eefa78c81b166dcf5143
-- Migrated: 2025-09-11T14:25:44.166Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_cea00594b03f48aa__"))()
local SaveManager = loadstring(game:HttpGet("__URL_a5202798473bfabd__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_a2b09db10de8d58c__"))()
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "Mga Item sa Spawn", Icon = "package" })
}
