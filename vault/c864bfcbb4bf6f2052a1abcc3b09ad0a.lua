...
-- Script ID: c864bfcbb4bf6f2052a1abcc3b09ad0a
-- Migrated: 2025-09-11T13:21:32.411Z
...
toggleButton.Text = "Activate Speed Hook"
...
infoLabel.Text = "Toggle handles buy + equip automatically"
...
local function activateSpeedHook()
    ...
    if player.Character and player.Character:FindFirstChild("Humanoid") then
        ...
        toggleButton.Text = "Deactivate Speed Hook"
