...
-- Script ID: 67d0034858e586da68316aa33102d65c
-- Migrated: 2025-09-11T14:25:41.800Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_a63205374ce348c0__"))()
local SaveManager = loadstring(game:HttpGet("__URL_39c075731738cfa4__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_c314b4743aee4219__"))()
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "Objets éparpillés", Icon = "package" })
}
...
local PlatformDropdown = Tabs.Spawn:AddDropdown("PlatformDropdown", {
    Title = "Sélectionnez la plate-forme",
    Values = Platforms,
    Multi = false,
    Default = 1,
})
...
local BuildToolsDropdown = Tabs.Spawn:AddDropdown("BuildToolsDropdown", {
    Title = "Sélectionner l'outil de construction",
    Values = BuildTools,
    Multi = false,
    Default = 1,
})
