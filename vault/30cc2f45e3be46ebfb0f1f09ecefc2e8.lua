...
-- Script ID: 30cc2f45e3be46ebfb0f1f09ecefc2e8
-- Created: 2025-12-31T11:15:30.447Z
-- Source: External API
...
if clientId == "" then
    return {
        success = false,
        error = "Не указан идентификатор клиента"
    }
end
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local MainGroup = Tabs.Validation:AddLeftGroupbox("Введите ключ валидации")
    ...
    MainGroup:AddInput("KeyInput", {
        ...
        Text = "Введите ключ",
        Placeholder = "Вставьте ключ валидации",
    ...
    MainGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "Скопировано",
                Description = "Ссылка на ключ валидации скопирована в буфер обмена",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "Скопировано",
                Description = "Ссылка на канал на YouTube скопирована в буфер обмена",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        Text = "Сервер на Discord",
        Func = function()
            setclipboard("https://discord.gg/9FWBQnVXCy")
            Library:Notify({
                Title = "Скопировано",
                Description = "Ссылка на сервер на Discord скопирована в буфер обмена",
                Time = 2
            })
        end
    })
