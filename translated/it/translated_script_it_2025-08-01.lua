...
local Window = Fluent:CreateWindow({
    Title = "COMBO_WICK",
    SubTitle = "Ottimizzazione per disposit...",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Funzioni principali", Icon = "target" }),
    Shop = Window:AddTab({ Title = "Negozio", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "Script server", Icon = "server" }),
    Watcher = Window:AddTab({ Title = "Brainrot Watcher", Icon = "eye" }),
    Settings = Window:AddTab({ Title = "Impostazioni", Icon = "settings" })
}
...
do
    ...
    local PlotTracers = Tabs.Main:AddToggle("PlotTracers", {
        Title = "Mostra tutti i timer di base",
    ...
    local ShowInvisible = Tabs.Main:AddToggle("ShowInvisible", {
        Title = "Mostra giocatori invisibili",
    ...
    Tabs.Main:AddButton({
        Title = "Potenziamento salto in alto",
    ...
    local ServerInfoParagraph = Tabs.Server:AddParagraph({
        Title = "Dettagli server corrente",
    ...
    local WatchAll = Tabs.Watcher:AddToggle("WatchAll", {
        Title = "Guarda Tutti i Brainrots",
    ...
    Tabs.Watcher:AddButton({
        Title = "Cancella ESP per animali do...",
