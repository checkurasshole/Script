...
-- Script ID: f8a5ba175d12b7dbaf629740e357ad77
-- Updated: 2025-10-01T20:20:53.773Z
...
local function handleBuildStatus(status, data)
    ...
    elseif status == "cancelled" then
        WindUI:Notify({
            Title = "Edifício Cancelado",
            Content = "Parado em" .. data.wallNumber,
            Icon = "x-circle",
            Duration = 3
        })
    elseif status == "placement_failed" then
        WindUI:Notify({
            Title = "FALHA NO ⚠️ POSICIONAMENTO",
            Content = "Parede" .. data.wallNumber,
            Icon = "alert-triangle",
            Duration = 10
        })
    elseif status == "walls_not_appearing" then
        WindUI:Notify({
            Title = "⚠️ AS PAREDES NÃO APARECEM",
            Content = "",
            Icon = "alert-triangle",
            Duration = 10
        })
...
local MainTab = Window:Tab({ Title = "Missão principal", Icon = "zap" })
local DiamondFarmTab = Window:Tab({ Title = "Diamond Farm", Icon = "gem" })
local CollectorTab = Window:Tab({ Title = "Coletor de Itens", Icon = "package" })
local PivotTab = Window:Tab({ Title = "MainFire", Icon = "move" })
local CombatTab = Window:Tab({ Title = "Sistema de Combate", Icon = "sword" })
local CookingTab = Window:Tab({ Title = "Culinária/Alimentação", Icon = "flame" })
local VisualTab = Window:Tab({ Title = "Ferramentas Visuais", Icon = "eye" })

-- WINDUI TABS (BELOW)
local LogWallTab = Window:Tab({ Title = "Paredes de Toras", Icon = "shield" })
local PlantHouseTab = Window:Tab({ Title = "Plantas/Casas", Icon = "home" })
local ConfigTab = Window:Tab({ Title = "Configuração", Icon = "save" })
local SettingsTab = Window:Tab({ Title = "Definições", Icon = "settings" })

-- =====================
-- MAIN QUEST TAB
-- =====================
MainTab:Button({
    Title = "Automação de missões",
    Desc = "",
    Icon = "info",
...
MainTab:Toggle({
    Title = "Desbloquear Mapa + Obter Crianças",
    Desc = "",
    Value = false,
    ...
    Callback = function(Value)
        ...
        if Value then
            ...
            if success then
                ...
                WindUI:Notify({
                    Title = "Carregamento Falhou",
                    Content = "Não foi possível carregar o script da fazenda de diamantes",
                    Icon = "x-circle",
                    Duration = 5
                })
            end
            ...
            WindUI:Notify({
                Title = "Diamond Farm Desativado",
                Content = "Desativar - o script ainda pode estar em execução",
                Icon = "info",
                Duration = 2
            })
        end
...
local PlayerDropdown = CollectorTab:Dropdown({
    Title = "Coletar Itens para o Jogador",
    Desc = "",
    ...
    Callback = function(Value)
        ...
        WindUI:Notify({
            Title = "Jogador Alvo Alterado",
            Content = "Os artigos serão recolhidos para" .. Value,
            Duration = 2
        })
    end
})
...
local ItemDropdown = CollectorTab:Dropdown({
    Title = "Selecione um Tipo de Item",
    Desc = "",
...
CollectorTab:Button({
    Title = "Recolher Itens Selecionados",
    Desc = "",
    Icon = "download",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
        if selectedItem then
            ...
            WindUI:Notify({
                Title = "Sem seleção",
                Content = "Selecione um primeiro item.",
                Duration = 2
            })
        end
    end
...
CollectorTab:Toggle({
    Title = "Detecção de Baú de Diamante",
...
CollectorTab:Toggle({
    Title = "Saquear Novos Itens Automaticamente",
...
CollectorTab:Toggle({
    Title = "Coleta Automática de Moedas",
...
PivotTab:Button({
    Title = "Teletransportar para a posição seleccionada",
    Desc = "",
    Icon = "map-pin",
    Callback = function()
...
PivotTab:Toggle({
    Title = "Espalhe os itens ao redor",
    Desc = "",
    Value = true,
    Callback = function(Value)
...
-- =====================
CombatTab:Button({
    Title = "Detecção Automática de Armas",
...
CombatTab:Dropdown({
    Title = "Seleccionar tipo de árvore",
    Desc = "",
...
CombatTab:Button({
    Title = "Instantâneo TODOS OS PROMPTS",
    Desc = "",
    Icon = "zap",
    Callback = function()
        local modified = 0
        ...
        WindUI:Notify({
            Title = "Prompts Modificados",
            Content = "Definir" .. modified .. " prompts to instant",
            Duration = 2
        })
    end
})
...
CookingTab:Toggle({
    Title = "Sistema de Cozimento Automático",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
CookingTab:Toggle({
    Title = "Traga comida após o cozimento",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
CookingTab:Button({
    Title = "Dirija-se ao acampamento",
    Desc = "",
    Icon = "flame",
    Callback = function()
...
VisualTab:Toggle({
    Title = "Destacar nome do jogador",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
VisualTab:Button({
    Title = "Copiar Script de Teletransporte do Jogo",
    Desc = "",
    Icon = "copy",
    Callback = function()
...
LogWallTab:Button({
    Title = "MODO ⚠️ BETA - ESPERAR BUGS",
    Desc = "",
    Icon = "alert-triangle",
    Color = Color3.fromHex("#ff4830"),
    Callback = function() end
...
maxZoomSlider = LogWallTab:Slider({
    Title = "Distância máxima do zoom",
    Desc = "",
    Value = {
        Min = 50,
        Max = 2000,
...
previewToggle = LogWallTab:Toggle({
    Title = "Mostrar Pré-visualização",
    Desc = "",
...
LogWallTab:Button({
    Title = "Limpar pré-visualização",
    Desc = "",
    Icon = "trash-2",
    Callback = function()
        LogWallBuilder:ClearPreview()
        WindUI:Notify({
            Title = "Pré-visualização apagada",
            Content = "",
            Icon = "trash-2",
            Duration = 2
        })
...
LogWallTab:Button({
    Title = "CONSTRUA UM CÍRCULO AO REDOR DO ACAMPAMENTO",
    Desc = "",
    Icon = "zap",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
...
plantResourceButton = PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Recursos actualizados",
            Content = "As contagens de artigos foram atualizadas",
            Icon = "refresh-cw",
            Duration = 2
        })
    end
    ...
    Callback = function()
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            ...
            WindUI:Notify({
                ...
                Content = "Definir para a posição do jogador",
                Icon = "map-pin",
                Duration = 2
            })
        end
...
plantBuildSpeedSlider = PlantHouseTab:Slider({
    Title = "Velocidade de Construção (Rápida)",
    Desc = "",
    Value = {
        Min = 5,
        Max = 50,
...
PlantHouseTab:Button({
    ...
    Callback = function()
        if PlantHouseBuilder.config.isBuilding then
            WindUI:Notify({
                Title = "Já está a construir",
                Content = "Aguarde a conclusão da compilação atual",
                Icon = "alert-circle",
                Duration = 3
            })
            return
        ...
        if #allPoints > 0 then
            ...
            if available < #allPoints then
                WindUI:Notify({
                    Title = "Itens não suficientes",
                    Content = "Necessidade" .. (#allPoints - available) .. " more items",
                    Icon = "x-circle",
                    Duration = 5
                })
                return
            ...
            WindUI:Notify({
                Title = "Construção iniciada!",
                Content = "Criar" .. #allPoints .. " blocks",
                Icon = "hammer",
                Duration = 3
            })
        else
            WindUI:Notify({
                ...
                Content = "Por favor, selecione uma forma de planta ou tipo de casa",
                Icon = "alert-triangle",
                Duration = 3
            })
        end
...
PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Edifício parado",
            Content = "Todas as compilações pendentes canceladas",
            Icon = "square",
            Duration = 2
        })
    end
...
ConfigTab:Input({
    Title = "Nome da BD de configuração",
...
ConfigTab:Button({
    ...
    Callback = function()
        if configNameInput == "" then
            WindUI:Notify({
                Title = "Erro",
                Content = "Introduza primeiro um nome de configuração",
                Icon = "alert-circle",
                Duration = 3
            })
            return
...
configDropdown = ConfigTab:Dropdown({
    Title = "Selecionar a configuração...",
...
ConfigTab:Button({
    Title = "Atualizar lista de configuração",
...
ConfigTab:Button({
    Title = "Carregar e Executar (Paredes de Toras)",
    ...
    Callback = function()
        ...
        if not success then
            ...
            WindUI:Notify({
                Title = "Execução de Paredes de Toras",
                Content = selectedConfig,
                Icon = "zap",
                Duration = 2
            })
...
autoLoadToggle = ConfigTab:Toggle({
    Title = "Carregar na inicialização",
...
autoLoadConfigDropdown = ConfigTab:Dropdown({
    Title = "Configuração de Carregamento Automático",
...
-- =====================
SettingsTab:Button({
    Title = "Configuração da Colecção",
...
SettingsTab:Input({
    ...
    Callback = function(Value)
        ...
        if numValue and numValue >= 0 and numValue <= 1000 then
            ...
            WindUI:Notify({
                Title = "Conjunto de limites BigTree",
...
if autoLoadSettings.enabled and autoLoadSettings.configName then
    ...
    if configExists then
        ...
        WindUI:Notify({
            Title = "Carregado automaticamente",
...
WindUI:Notify({
    Title = "Último Hub de Ferramentas Carregado!",
    Content = "Todos os recursos prontos",
    Icon = "check-circle",
    Duration = 3
})
