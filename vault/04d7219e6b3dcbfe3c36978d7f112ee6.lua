-- Russian Translation
-- Script ID: 04d7219e6b3dcbfe3c36978d7f112ee6
-- Migrated: 2025-09-11T14:25:35.831Z
...
godModeToggle = Tab:AddToggle("GodMode", {
    Title = "Заморозить врагов (Боговой режим)",
    Default = false,
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "Завершить выполнение всех задач",
    Default = false,
    Callback = function(Value)
...
ObjectiveSection:AddToggle("InstantCompleteV2", {
    Title = "Незамедлительное достижение всех целей V2 (только для школ)",
    Default = false,
    Callback = function(Value)
...
CombatSection:AddToggle("InfPerk", {
    Title = "Активировать специальные навыки",
    Default = false,
    Callback = function(Value)
        pcall(function()
            InfPerkActive = Value
