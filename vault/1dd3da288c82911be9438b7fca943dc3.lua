...
-- Script ID: 1dd3da288c82911be9438b7fca943dc3
-- Migrated: 2025-09-11T13:21:03.365Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_169043cea52d8888__"))()
...
Tab:AddToggle("AutoSell", {Title = "Auto Sell", Default = false}):OnChanged(function(value)
...
ShopTab:AddParagraph({
    Title = "Custom Items",
    Content = "Add your own items to auto-buy"
})
