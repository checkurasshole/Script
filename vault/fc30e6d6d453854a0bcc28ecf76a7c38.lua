-- German Translation
-- Script ID: fc30e6d6d453854a0bcc28ecf76a7c38
-- Migrated: 2025-09-11T14:25:36.541Z
...
godModeToggle = Tab:AddToggle("GodMode", {
    Title = "Feinde einfrieren (Gott-Modus)",
    Default = false,
...
ObjectiveSection:AddToggle("InstantCompleteV2", {
    Title = "Sofortiger Abschluss aller Ziele V2 (nur Schule)",
    Default = false,
    Callback = function(Value)
...
ObjectiveSection:AddToggle("ReplayGame", {
    Title = "Aufzeichnung wiedergeben",
    Default = false,
    Callback = function(Value)
        if Value then
            task.spawn(function()
...
CombatSection:AddToggle("AllSkills", {
    Title = "Alle Fähigkeiten aktivieren",
    Default = false,
    Callback = function(Value)
        pcall(function()
...
CombatSection:AddToggle("InfPerk", {
    Title = "Spezialfähigkeit aktivieren",
    Default = false,
    Callback = function(Value)
        pcall(function()
            InfPerkActive = Value
...
doorActivatorToggle = CombatSection:AddToggle("DoorActivator", {
    Title = "Bitte öffnen Sie alle Türen",
    Default = false,
    Callback = function(Value)
