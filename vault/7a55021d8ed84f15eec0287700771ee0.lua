-- Script_1754579649435
-- Script ID: 7a55021d8ed84f15eec0287700771ee0
-- Migrated: 2025-09-11T12:58:15.468Z
...
local Rayfield = loadstring(game:HttpGet('__URL_02aabee56de30c80__'))()
...
local Tab = Window:CreateTab("メイン", nil)
local AmberTab = Window:CreateTab("アンバーコレクション", nil)
local UtilityTab = Window:CreateTab("ユーティリティ", nil)

-- Utility Tab (Anti-Void)
UtilityTab:CreateSection("アンチ・ヴォイド")
...
Tab:CreateSection("プレイヤーAutoFarm")
Tab:CreateToggle({
    Name = "プレイヤーへのテレポート",
    CurrentValue = false,
    Flag = "TeleportToggle",
