...
-- Script ID: 52e366a1608ace82f970eec1078d4462
-- Migrated: 2025-09-11T13:20:52.568Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_46fcd93d0d54284d__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_6758aa2da76c091a__"))()
...
Tab:AddParagraph({
    Title = "โหมดพระเจ้าสถานะโหมดพระเจ้าจะเปิดใช้งานโดยอัตโนมัติเมื่อโหลดสคริปต์",
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "การดำเนินการตามวัตถุประสงค์อัตโนมัติให้เสร็จสมบูรณ์",
    Default = false,
