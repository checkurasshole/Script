...
-- Script ID: c1e9c5ae17706a3986af7e1edfe7a957
-- Created: 2025-12-31T21:55:20.204Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local Tabs = {
        Validation = Window:AddTab("Validação", "key"),
        Info = Window:AddTab("Links de ﻿Informações", "info")
    }
        
    local validationComplete = false
    local validationSuccess = false
    
    local MainGroup = Tabs.Validation:AddLeftGroupbox("Insira sua chave")
    ...
    local LinksGroup = Tabs.Info:AddLeftGroupbox("Links rápidos")
    ...
    local HWIDGroup = Tabs.Info:AddRightGroupbox("Informações HWID")
