...
-- Script ID: 4b3a3a83ccd83870275da3d9cf6dc6dd
-- Migrated: 2025-09-11T13:20:56.707Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_bd1ebb247aaf9e85__"))()

local Window = Fluent:CreateWindow({
    Title = "Ferme et vente d'automobiles",
    SubTitle = "",
    TabWidth = 80,
...
local Tab = Window:AddTab({ Title = "Principales", Icon = "" })
local ShopTab = Window:AddTab({ Title = "Magasiner", Icon = "" })
...
Tab:AddToggle("AutoFarm", {Title = "Ferme automobile", Default = false}):OnChanged(function(value)
...
Tab:AddToggle("AutoSell", {Title = "Vente automatique", Default = false}):OnChanged(function(value)
...
for _, itemName in ipairs(shopItems) do
    ...
    ShopTab:AddToggle(toggleId, {
        Title = "Achat automatique" .. itemName, 
        Default = false
...
ShopTab:AddParagraph({
    ...
    Content = "Ajoutez vos propres articles à l'achat automatique"
})
...
ShopTab:AddButton({
    Title = "Ajouter le nom de l'élément Shop",
    ...
    Callback = function()
        ...
        if customItemName ~= "" and customItemName ~= nil and not customToggles[customItemName] then
            ...
            -- Create the toggle
            ShopTab:AddToggle(toggleId, {
                Title = "Achat automatique" .. customItemName,
                Default = false
            }):OnChanged(function(value)
