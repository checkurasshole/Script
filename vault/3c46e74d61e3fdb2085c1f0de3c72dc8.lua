...
-- Updated: 2026-09-09T02:29:26.485Z
...
MoveBox:AddSlider("se_walk",   { Text = "걷기 속도", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "랙 감소", Default = false, Callback = function(v) setAntiLag(v) end })
