...
-- Script ID: 0955bc63d68bc66b02723df0380eefa5
-- Created: 2025-10-18T02:33:52.248Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("Impormasyon ng HWID")
    ...
    LeftGroup:AddLabel({
        Text = "⚠️ Mga Istatistika",
        DoesWrap = false,
    })
    
    LeftGroup:AddLabel({
        Text = "Nangangailangan ng pagpapatunay ang access",
        DoesWrap = true,
    })
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("Mabilis na mga Link")
