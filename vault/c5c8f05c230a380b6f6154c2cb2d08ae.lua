...
-- Created: 2025-12-18T07:36:16.401Z
-- Source: External API
...
local Tabs = {
    Respawn = Window:AddTab("Respawn automático", "refresh-cw"),
    AimAssist = Window:AddTab("Assistente de AIM", "star"),
    Visuals = Window:AddTab("Artes visuais", "eye"),
...
local TriggerBox = Tabs.AimAssist:AddLeftGroupbox("Fotografia automática")
local ESPBox = Tabs.Visuals:AddLeftGroupbox("Jogador ESP")
local TracerBox = Tabs.Visuals:AddRightGroupbox("Marcadores")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("Ligar Automático", {
    Text = "Auto Play Loop",
    Default = false,
    Tooltip = "Respawn automático após a morte",
})
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "Ativar",
    Default = false,
    Tooltip = "Segure o botão direito para bloquear",
})
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "Ativar",
    Default = false,
    Tooltip = "Botão de bloqueio automático sem",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "Ativar",
    Default = false,
    Tooltip = "Disparo automático no bloqueio",
})
