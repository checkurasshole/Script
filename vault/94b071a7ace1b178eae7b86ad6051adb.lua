...
-- Script ID: 94b071a7ace1b178eae7b86ad6051adb
-- Migrated: 2025-09-11T13:21:26.068Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_1d6d5bb9f57c23e1__"))()
local SaveManager = loadstring(game:HttpGet("__URL_06c1e0078e7d8c65__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_c9ed1365eaf9fe49__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "메인", Icon = "" })
}
