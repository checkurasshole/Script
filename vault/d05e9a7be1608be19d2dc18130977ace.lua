...
-- Script ID: d05e9a7be1608be19d2dc18130977ace
-- Created: 2025-10-10T17:13:42.470Z
-- Source: External API
...
local Tabs = {
    ...
    PrivateServer = Window:AddTab({ Title = "Servidor privado", Icon = "lock" })
}
...
local saveFileName = "InfMoneyActived_" .. LocalPlayer.UserId .. ".txt"
...
Tabs.PrivateServer:AddButton({
    Title = "Unirse al servidor privado",
    Callback = function()
