...
-- Script ID: 29fcb9d1b207ea2ce79019cf949c9632
-- Migrated: 2025-09-11T14:25:43.362Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_54f41cdd64adbb31__"))()
local SaveManager = loadstring(game:HttpGet("__URL_8dfe831508ba632c__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_355e082f558a1c93__"))()
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "Sản phẩm sinh sản", Icon = "package" })
}
