...
-- Updated: 2026-09-12T04:11:42.499Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "Jangan jual (kelangkaan)" })
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("Tak ada pukulan dalam 25 detik"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Gagal mengambil target"); unlockMove(); return end
            stolen = stolen + 1
