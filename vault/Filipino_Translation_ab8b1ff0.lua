...
-- Script ID: ab8b1ff02517faa814a1fc4514d52285
-- Updated: 2025-09-11T19:27:38.519Z
...
Tab:AddParagraph({
    Title = "Estado",
    Content = "Pinakamahusay na gumagana sa Single Player"
})

godModeToggle = Tab:AddToggle("GodMode", {
    Title = "I - freeze ang mga Kalaban(God Mode)",
    Default = false,
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "Kumpletuhin ang Lahat ng Layunin",
    Default = false,
    Callback = function(Value)
...
ObjectiveSection:AddToggle("InstantCompleteV2", {
    Title = "Instant Kumpletuhin ang Lahat ng Mga Layunin V2 (Paaralan Lamang)",
    Default = false,
    Callback = function(Value)
...
TeleportSection:AddSlider("HeightOffset", {
    Title = "Distansya sa itaas Zombie",
...
CombatSection:AddToggle("AllSkills", {
    Title = "I - activate ang Lahat ng Kasanayan",
    Default = false,
    Callback = function(Value)
        pcall(function()
...
CombatSection:AddToggle("InfPerk", {
    Title = "I - activate ang Espesyal na Kasanayan",
    Default = false,
    Callback = function(Value)
        pcall(function()
            InfPerkActive = Value
...
doorActivatorToggle = CombatSection:AddToggle("DoorActivator", {
    Title = "Buksan ang Lahat ng Pinto",
    Default = false,
    Callback = function(Value)
