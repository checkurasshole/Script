...
-- Updated: 2026-09-12T04:11:35.505Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "ห้ามขาย (ความหายาก)" })
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("ไม่พบการโดนตีใน 25 วินาที"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("คว้าเป้าหมายล้มเหลว"); unlockMove(); return end
            stolen = stolen + 1
