...
-- Updated: 2026-09-12T04:11:30.371Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "Nicht verkaufen (Seltenheiten)" })
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("Kein Treffer in 25s erkannt"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Ziel greifen fehlgeschlagen"); unlockMove(); return end
            stolen = stolen + 1
