...
-- Script ID: 69d6127919ba2e46be2c54d560cbf53c
-- Created: 2025-12-31T16:39:00.823Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LinksGroup = Tabs.Info:AddLeftGroupbox("Enlaces útiles")
    ...
    HWIDGroup:AddButton({
        Text = "📋 Copiar ID de HWID",
        Func = function()
            setclipboard(clientId)
            Library:Notify({
                Title = "ID de HWID copiado",
                Description = "ID de HWID copiado al portapapeles",
                Time = 2
            })
        end
    })
    ...
    if validationSuccess then
        ...
        if whitelisted then
            ...
            return {
                success = false,
                error = "no_whitelisted_after_validation"
            }
        end
    else
        return {
