...
-- Updated: 2026-09-09T02:29:12.804Z
...
MoveBox:AddSlider("se_walk",   { Text = "Walk Speed", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Reduce Lag", Default = false, Callback = function(v) setAntiLag(v) end })
