...
-- Script ID: 034afa7c4624491d74a64a59b3c826dd
-- Migrated: 2025-09-11T13:21:18.518Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_98bca8f949b7ac52__"))()
local SaveManager = loadstring(game:HttpGet("__URL_7b3b5b37471c0ad8__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_e1c71bbbcd822881__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "메인", Icon = "activity" }),
    Shop = Window:AddTab({ Title = "상점", Icon = "shopping-cart" }),
    AntiAFK = Window:AddTab({ Title = "노킥", Icon = "shield" })
}
