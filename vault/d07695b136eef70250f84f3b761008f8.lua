...
-- Script ID: d07695b136eef70250f84f3b761008f8
-- Migrated: 2025-09-11T13:20:55.895Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_27e783cd79fbc49e__"))()

local Window = Fluent:CreateWindow({
    Title = "Auto Granja y venta",
    SubTitle = "",
    TabWidth = 80,
...
ShopTab:AddButton({
    Title = "Añadir nombre del elemento de la tienda",
