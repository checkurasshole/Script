-- Script_1754579523507
-- Script ID: b6a4c81466e97c39fbbd81a92438106f
-- Migrated: 2025-09-11T12:58:11.405Z
...
local Rayfield = loadstring(game:HttpGet('__URL_e0062b299c45fdeb__'))()
...
UtilityTab:CreateButton({
    Name = "Fake Out (Teleport Below Map)",
    Callback = function()
        fakeOut()
    end
})
