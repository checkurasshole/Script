...
-- Script ID: afb89b753c2617508845220eef7b0c13
-- Migrated: 2025-09-11T13:21:27.611Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_9246b938808c0e09__"))()
local SaveManager = loadstring(game:HttpGet("__URL_95e9cad7a0e7d529__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_0dda7b4d9b4faaed__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Главное", Icon = "" })
}
...
local UpgradesButton = Tabs.Main:AddButton({
    Title = "Телепорт для повышения квалификации",
    Callback = function()
        teleportToUpgrades()
    end
})
