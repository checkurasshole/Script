...
-- Updated: 2026-09-09T02:29:48.829Z
...
MoveBox:AddSlider("se_walk",   { Text = "Bilis ng Paglakad", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Bawasan ang Lag", Default = false, Callback = function(v) setAntiLag(v) end })
