...
local Tabs = {
    Main = Window:AddTab({ Title = "Funções Principais", Icon = "target" }),
    Shop = Window:AddTab({ Title = "Loja", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "Scripts do servidor", Icon = "server" }),
    Watcher = Window:AddTab({ Title = "Brainrot Watcher", Icon = "eye" }),
    Settings = Window:AddTab({ Title = "Definições", Icon = "settings" })
}
...
do
    ...
    local PlotTracers = Tabs.Main:AddToggle("PlotTracers", {
        Title = "Mostrar todos os temporizad...",
    ...
    local ShowInvisible = Tabs.Main:AddToggle("ShowInvisible", {
        Title = "Mostrar jogadores invisíveis",
    ...
    local AntiTrap = Tabs.Main:AddToggle("AntiTrap", {
        Title = "Anti Armadilha + Anti Abelha",
    ...
    Tabs.Main:AddButton({
        Title = "Impulso de salto em altura",
    ...
    Tabs.Main:AddButton({
        Title = "Dar todas as ferramentas",
    ...
    local ServerInfoParagraph = Tabs.Server:AddParagraph({
        Title = "Detalhes do Servidor Actual",
    ...
    local WebhookInput = Tabs.Watcher:AddInput("WebhookInput", {
        Title = "URL do webhook do Discord",
    ...
    local WatchAll = Tabs.Watcher:AddToggle("WatchAll", {
        Title = "Assista a todas as Brainrots",
