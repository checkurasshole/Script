...
-- Script ID: 00962a69efe00678014962b9266562a5
-- Migrated: 2025-09-11T13:21:20.066Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_fb3c72b1de0e1de8__"))()
local SaveManager = loadstring(game:HttpGet("__URL_978394ef92d637b0__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_c917c97cd877f954__"))()
...
ScreenGui.Name = "Togggle ComboWickTogle"
...
local Tabs = {
    Main = Window:AddTab({ Title = "Главное", Icon = "activity" }),
    Shop = Window:AddTab({ Title = "Магазин", Icon = "shopping-cart" }),
    AntiAFK = Window:AddTab({ Title = "Никакого Кика", Icon = "shield" })
}
