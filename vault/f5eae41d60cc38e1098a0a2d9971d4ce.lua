...
-- Script ID: f5eae41d60cc38e1098a0a2d9971d4ce
-- Migrated: 2025-09-11T13:21:16.047Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_f1c5da186bf56de4__"))()
local SaveManager = loadstring(game:HttpGet("__URL_7173593eddf88789__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_ee34203d0723e23b__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Principales", Icon = "activity" }),
    Shop = Window:AddTab({ Title = "Magasiner", Icon = "shopping-cart" }),
    AntiAFK = Window:AddTab({ Title = "Pas de coup de pied", Icon = "shield" })
}
...
Tabs.Shop:AddToggle("AutoLeg", {
    Title = "Acheter des jambes en auto",
    Default = false,
    Callback = function(Value)
        autoBuyLeg = Value
        if Value then
...
Tabs.Shop:AddToggle("AutoArm", {
    Title = "Acheter automatiquement des armes", 
    Default = false,
    Callback = function(Value)
        autoBuyArm = Value
        if Value then
...
Tabs.Shop:AddToggle("AutoHead", {
    Title = "Tête d'achat automatique",
    Default = false,
    Callback = function(Value)
        autoBuyHead = Value
        if Value then
