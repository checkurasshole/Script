...
-- Script ID: 425c10591636b349a5456123f62525cc
-- Migrated: 2025-09-11T12:58:35.981Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_615686afb1a8972d__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_b4643a18f054657c__"))()
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "Finalización automática del objetivo",
    Default = false,
...
TeleportSection:AddButton({
    Title = "Mapa de dos lugares seguros",
    Callback = function()
        pcall(function()
            local Character = Player.Character
...
CombatSection:AddToggle("AllSkills", {
    Title = "Todas las habilidades Spam",
    Default = false,
    Callback = function(Value)
        pcall(function()
