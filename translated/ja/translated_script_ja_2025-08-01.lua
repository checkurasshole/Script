...
local Tabs = {
    Main = Window:AddTab({ Title = "主な機能", Icon = "target" }),
    Shop = Window:AddTab({ Title = "ショップ", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "サーバースクリプト", Icon = "server" }),
    Watcher = Window:AddTab({ Title = "ブレインロット・ウォッチャー", Icon = "eye" }),
