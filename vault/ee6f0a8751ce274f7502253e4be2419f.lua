...
-- Script ID: ee6f0a8751ce274f7502253e4be2419f
-- Migrated: 2025-09-11T13:21:26.805Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_cef2e29457667062__"))()
local SaveManager = loadstring(game:HttpGet("__URL_022999a43cc04d3d__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_37c40f6ac754a554__"))()
...
local UpgradesButton = Tabs.Main:AddButton({
    Title = "Teletransportar para Upgrades",
    Callback = function()
        teleportToUpgrades()
    end
})
...
local WeaponsButton = Tabs.Main:AddButton({
    Title = "Teletransportar para Armas",
    Callback = function()
        teleportToWeapons()
    end
})
