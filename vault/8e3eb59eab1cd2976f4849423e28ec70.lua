...
-- Script ID: 8e3eb59eab1cd2976f4849423e28ec70
-- Migrated: 2025-09-11T13:21:16.947Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_e03fc486b1bc4ae1__"))()
local SaveManager = loadstring(game:HttpGet("__URL_a6c92c3afbb5322f__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_af9f8dbffa443184__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Haupt", Icon = "activity" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shopping-cart" }),
    AntiAFK = Window:AddTab({ Title = "Kein Kick", Icon = "shield" })
}
...
Tabs.Main:AddSlider("PowerSlider", {
    Title = "Kraft- & Geschwindigkeitsschlitten",
    Default = 300,
    Min = 100,
    Max = 1000,
    Rounding = 10,
...
Tabs.Shop:AddToggle("AutoLeg", {
    Title = "Automatischer Kauf von Beinen",
    Default = false,
    Callback = function(Value)
        autoBuyLeg = Value
        if Value then
...
Tabs.Shop:AddToggle("AutoArm", {
    Title = "Waffen automatisch kaufen", 
    Default = false,
    Callback = function(Value)
        autoBuyArm = Value
        if Value then
...
Tabs.Shop:AddToggle("AutoTorso", {
    Title = "Torso automatisch kaufen",
    Default = false,
    Callback = function(Value)
        autoBuyTorso = Value
        if Value then
