...
-- Updated: 2026-09-12T04:11:33.111Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "Ne pas vendre (raretés)" })
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("Aucun coup détecté en 25s"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Échec de la prise de la cible"); unlockMove(); return end
            stolen = stolen + 1
