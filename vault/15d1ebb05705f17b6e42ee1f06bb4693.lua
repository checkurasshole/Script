-- Script_1754579689996
-- Script ID: 15d1ebb05705f17b6e42ee1f06bb4693
-- Migrated: 2025-09-11T12:58:16.792Z
...
local Rayfield = loadstring(game:HttpGet('__URL_4f276535d48c3c92__'))()
...
local Window = Rayfield:CreateWindow({
    Name = "COMBO_WICK",
    Icon = 12345678901,
    LoadingTitle = "استمتعوا!",
    LoadingSubtitle = "بواسطة COMBO_WICK",
    Theme = "Ocean",
    ConfigurationSaving = {
        Enabled = true,
...
local Tab = Window:CreateTab("الرئيسي", nil)
local AmberTab = Window:CreateTab("مجموعة العنبر", nil)
local UtilityTab = Window:CreateTab("مرفق", nil)

-- Utility Tab (Anti-Void)
UtilityTab:CreateSection("مضاد للبطلان")
UtilityTab:CreateToggle({
    Name = "تمكين مضاد الفراغ",
    CurrentValue = false,
    Flag = "AntiVoidToggle",
...
UtilityTab:CreateButton({
    Name = "التزييف (الانتقال الفوري أس...",
    Callback = function()
        fakeOut()
    end
})
...
-- Main Tab
Tab:CreateSection("سرعة السير")
Tab:CreateToggle({
    Name = "تمكين سرعة المشي",
    CurrentValue = false,
...
Tab:CreateSection("مزرعة ذاتية للحيوانات")
Tab:CreateToggle({
    Name = "تمكين اسم ESP",
    CurrentValue = false,
    Flag = "ESPNameToggle",
...
Tab:CreateToggle({
    Name = "الانتقال الفوري إلى المراكز...",
    CurrentValue = false,
...
Tab:CreateSection("مزرعة تلقائية للاعب")
Tab:CreateToggle({
    Name = "الانتقال الفوري إلى اللاعبين",
    CurrentValue = false,
    Flag = "TeleportToggle",
    Callback = function(value)
        teleporting = value
...
Tab:CreateToggle({
    Name = "اللاعبون المتحركون المستهدفون",
    CurrentValue = true,
...
Tab:CreateToggle({
    Name = "اللاعبون الساكنون المستهدفون",
    CurrentValue = true,
