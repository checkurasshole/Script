...
-- Created: 2025-12-31T21:39:40.271Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local MainGroup = Tabs.Validation:AddLeftGroupbox("ใส่ข้อมูลของคุณ")
    ...
    local LinksGroup = Tabs.Info:AddLeftGroupbox("ลิงค์ด่วน")
