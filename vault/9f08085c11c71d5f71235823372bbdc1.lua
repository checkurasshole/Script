...
-- Script ID: 9f08085c11c71d5f71235823372bbdc1
-- Created: 2025-12-22T16:26:08.337Z
-- Source: External API
-- Auto-generated by Lua Script Vault

-- Main Script
-- Это загружает модуль и создает интерфейс
...
-- Main Purchases Box
local MainBox = Tabs.Main:AddLeftGroupbox("Покупки", "package")
...
-- Manual Purchase Box
local ManualBox = Tabs.Main:AddRightGroupbox("Ручная покупка", "edit")
