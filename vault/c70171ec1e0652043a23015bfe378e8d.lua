...
-- Script ID: c70171ec1e0652043a23015bfe378e8d
-- Created: 2025-10-19T14:54:42.681Z
-- Source: External API
...
local Tabs = {
    Main = Window:AddTab("Ra-đa", "eye"),
    AutoWalk = Window:AddTab("Săn mục tiêu", "navigation"),
    Collect = Window:AddTab("Nhận tiền", "dollar-sign"),
    PrivServer = Window:AddTab("Chế độ Máy chủ", "server"),
...
local ESPGroupBox = Tabs.Main:AddLeftGroupbox("Tùy Chọn Hiển Thị", "eye")

ESPGroupBox:AddToggle("ESPToggle", {
    Text = "Hiển thị điểm đánh dấu thú cưng",
    Default = false,
    Callback = function(v)
        espEnabled = v
        if not v then
...
ESPGroupBox:AddToggle("TracerToggle", {
    Text = "Hiển thị các đường định hướng",
    Default = false,
    Callback = function(v)
        tracerEnabled = v
        if not v then
...
local AnimalGroupBox = Tabs.Main:AddRightGroupbox("Bộ lọc thú cưng", "filter")

AnimalGroupBox:AddDropdown("CommonDropdown", {
    Values = ComboWick.commonAnimals,
    Multi = true,
    Default = 1,
    Text = "Thú cưng tiêu chuẩn",
...
AnimalGroupBox:AddDropdown("AdminDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "Quản trị viên/Thú cưng OG",
    Callback = function(Value)
...
local AutoWalkGroupBox = Tabs.AutoWalk:AddLeftGroupbox("Cài đặt Hunt", "navigation")

AutoWalkGroupBox:AddToggle("AutoWalkToggle", {
    Text = "Bắt đầu săn thú cưng",
    Default = false,
    Callback = function(v)
        autoWalkEnabled = v
        if v then
...
local CollectGroupBox = Tabs.Collect:AddLeftGroupbox("Cài đặt xác nhận quyền sở", "dollar-sign")

CollectGroupBox:AddToggle("CollectMoneyToggle", {
    Text = "Xác nhận quyền sở hữu Tự",
    Default = false,
    Callback = function(v)
...
local StatusGroupBox = Tabs.Collect:AddRightGroupbox("Trạng thái", "activity")
...
local PrivServerGroupBox = Tabs.PrivServer:AddLeftGroupbox("Máy chủ SIP cá nhân", "server")
