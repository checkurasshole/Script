...
local Tabs = {
    Main = Window:AddTab({ Title = "Fonctions principales", Icon = "target" }),
    Shop = Window:AddTab({ Title = "Magasiner", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "Scripts du serveur", Icon = "server" }),
    Watcher = Window:AddTab({ Title = "Observateur de brainrot", Icon = "eye" }),
...
local function addESP(animal, index)
    ...
    highlight.Name = "HautAnimalHaut de la page"..index
    ...
    billboard.Name = "TopAnimalLabel"..index
...
do
    ...
    local PlotTracers = Tabs.Main:AddToggle("PlotTracers", {
        Title = "Afficher tous les minuteurs...",
    ...
    local ShowInvisible = Tabs.Main:AddToggle("ShowInvisible", {
        Title = "Afficher les joueurs invisi...",
    ...
    local ServerInfoParagraph = Tabs.Server:AddParagraph({
        Title = "Détails du serveur actuel",
    ...
    local WatchAll = Tabs.Watcher:AddToggle("WatchAll", {
        Title = "Regardez tous les Brainrots",
    ...
    Tabs.Watcher:AddButton({
        Title = "Animaux de compagnie de la ...",
    ...
    Tabs.Watcher:AddButton({
        Title = "Effacer la liste trouvée",
    ...
    Tabs.Watcher:AddButton({
        Title = "Envoyer des informations su...",
