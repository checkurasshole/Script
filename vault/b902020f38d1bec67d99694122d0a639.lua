...
-- Script ID: b902020f38d1bec67d99694122d0a639
-- Created: 2025-12-22T16:26:10.082Z
-- Source: External API
-- Auto-generated by Lua Script Vault

-- Main Script
-- Ito ay naglo-load ng module at lumilikha ng UI
...
-- Main Purchases Box
local MainBox = Tabs.Main:AddLeftGroupbox("Mga Pagbili", "package")

task.spawn(function()
    local items = ComboWick.fetchAllItems()
    
    if #items > 0 then
        -- Proseso at pagpapalit ng pangalan ng mga item
        ...
        -- Magdagdag ng mga item sa pagkakasunud-sunod ng priyoridad
        if specialItem then
        ...
        -- Magdagdag ng pindutan ng "Kunin ang Lahat"
        MainBox:AddButton({
            Text = "Kunin ang Lahat!",
            Func = function()
        ...
        -- Magdagdag ng toggle para sa bawat item
...
-- Manual Purchase Box
local ManualBox = Tabs.Main:AddRightGroupbox("Manwal na Pagbili", "edit")
...
ManualBox:AddInput("ManualID", {
    ...
    Finished = true,
    Text = "ID ng Item",
    Placeholder = "Ipagpasok ang ID ng Item",
    Callback = function(Value)
