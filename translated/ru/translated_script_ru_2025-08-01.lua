...
local Window = Fluent:CreateWindow({
    Title = "COMBO_WICK",
    SubTitle = "Оптимизация мобильной связи",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Основные функции", Icon = "target" }),
    Shop = Window:AddTab({ Title = "Магазин", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "Скрипты серверов", Icon = "server" }),
    Watcher = Window:AddTab({ Title = "Мозговой наблюдатель", Icon = "eye" }),
    Settings = Window:AddTab({ Title = "Параметры", Icon = "settings" })
}
...
local function addESP(animal, index)
    ...
    highlight.Name = "Верхний этаж"..index
...
do
    ...
    local PlotTracers = Tabs.Main:AddToggle("PlotTracers", {
        Title = "Показать все базовые таймеры",
    ...
    local AutoRebirth = Tabs.Main:AddToggle("AutoRebirth", {
        Title = "Автомобильное возрождение",
    ...
    local ShowInvisible = Tabs.Main:AddToggle("ShowInvisible", {
        Title = "Показать невидимых игроков",
    ...
    Tabs.Server:AddButton({
        Title = "Копировать идентификатор до...",
    ...
    local WatcherToggle = Tabs.Watcher:AddToggle("WatcherToggle", {
        Title = "Использовать наблюдателя",
    ...
    local WatchAll = Tabs.Watcher:AddToggle("WatchAll", {
        Title = "Наблюдать за всеми мозгами",
    ...
    Tabs.Watcher:AddButton({
        Title = "Очистить список найденных",
    ...
    Tabs.Watcher:AddButton({
        Title = "Отправить серверную информацию",
