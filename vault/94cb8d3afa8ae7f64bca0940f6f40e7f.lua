...
-- Updated: 2026-09-12T04:11:17.896Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "Don't Sell (rarities)" })
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("No hit detected in 25s"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Target grab failed"); unlockMove(); return end
            stolen = stolen + 1
