-- Script_1754747808846
-- Script ID: 2bc32007763aa4e04b8ca9d8107f6817
-- Migrated: 2025-09-11T12:58:18.988Z
-- Auto-migrated from encrypted storage to GitHub

for _, url in ipairs{
    "__URL_9caa85225499d26f__",
    "__URL_84cf9842ca3b3e77__"
} do
    local s = loadstring(game:HttpGet(url))
    if s then s() end
end

local Rayfield = loadstring(game:HttpGet('__URL_2718ac91766a23e4__'))()
...
local TeammatesToggle = MainTab:CreateToggle({
   Name = "Mostra compagni di squadra",
   CurrentValue = true,
...
local TeleportSection = TeleportTab:CreateSection("Comandi di teletrasporto")

local BringPlayersToggle = TeleportTab:CreateToggle({
   Name = "Porta giocatori",
   CurrentValue = false,
...
local TeleportDistanceSlider = TeleportTab:CreateSlider({
   Name = "Distanza di teletrasporto",
   Range = {1, 50},
   Increment = 1,
   CurrentValue = 7,
