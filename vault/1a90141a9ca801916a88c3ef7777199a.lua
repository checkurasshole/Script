...
-- Script ID: 1a90141a9ca801916a88c3ef7777199a
-- Created: 2025-10-18T02:37:55.004Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("Información HWID")
    ...
    LeftGroup:AddLabel({
        Text = "El acceso requiere validación",
        DoesWrap = true,
    })
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("Enlaces rápidos")
