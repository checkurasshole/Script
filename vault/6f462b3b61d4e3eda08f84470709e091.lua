...
-- Created: 2025-12-18T07:36:13.001Z
-- Source: External API
...
local Tabs = {
    ...
    AimAssist = Window:AddTab("Zielassistent", "star"),
    Visuals = Window:AddTab("Visuals", "eye"),
    ["UI Settings"] = Window:AddTab("UI Einstellungen", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("Auto-Play-Schleife")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("Version 1 - Manueller PC")
...
local TracerBox = Tabs.Visuals:AddRightGroupbox("Kennzeichnungsmittel")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("AutoPlay", {
    Text = "Auto-Play-Schleife",
    Default = false,
    Tooltip = "Automatisches Respawn bei Tod",
})
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "Ermöglichen",
    Default = false,
    Tooltip = "Zum Sperren Rechtsklick gedrückt halten",
})
...
AimbotV1Box:AddSlider("AimbotV1Glättung", {
    Text = "Glättung",
    Default = 5,
    Min = 1,
    Max = 20,
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "Ermöglichen",
    Default = false,
    Tooltip = "Automatische Sperre keine Taste",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "Ermöglichen",
    Default = false,
    Tooltip = "Auto-Shoot auf Sperre",
})

TriggerBox:AddSlider("Verzögerung", {
    Text = "Verzögerung (Millisek.)",
    Default = 50,
    Min = 0,
    Max = 500,
    Rounding = 0,
...
ESPBox:AddToggle("RainbowESP", {
    Text = "Regenbogenmodus",
    Default = false,
})

TracerBox:AddToggle("Kennzeichnungsmittel", {
    Text = "Ermöglichen",
    Default = false,
})
...
TracerBox:AddSlider("TracerDicke", {
    Text = "Dicke",
    Default = 1,
    Min = 1,
    Max = 5,
...
TracerBox:AddToggle("Regenbogen-Tracer", {
    Text = "Regenbogenmodus",
    Default = false,
})
