...
-- Main Tab
local MainTab = Window:CreateTab("Controles de automóviles", "car")
...
local HideCashEffectsButton = MainTab:CreateButton({
   Name = "Ocultar efectos en efectivo",
   Callback = function()
...
-- Upgrades Tab
local UpgradesTab = Window:CreateTab("Actualizaciones", "trending-up")

-- Brainrot Speed Toggle
local BrainrotToggle = UpgradesTab:CreateToggle({
   Name = "Velocidad de Brainrot",
   CurrentValue = false,
   Flag = "BrainrotToggle",
   Callback = function(Value)
