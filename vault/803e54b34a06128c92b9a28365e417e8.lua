...
-- Script ID: 803e54b34a06128c92b9a28365e417e8
-- Migrated: 2025-09-11T14:25:46.479Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_faad5fe1341f145e__"))()
local SaveManager = loadstring(game:HttpGet("__URL_7d91cee0545c10bd__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_46fb4117f3473e1d__"))()
...
toggleGui.Name = "Свободный Togglegui"
...
toggleButton.Name = "Заголовок@ info: whatsthis"
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "Пункты для лопаток", Icon = "package" })
}
...
local BuildToolsDropdown = Tabs.Spawn:AddDropdown("BuildToolsDropdown", {
    Title = "Выбрать инструмент построения",
    Values = BuildTools,
    Multi = false,
    Default = 1,
})
