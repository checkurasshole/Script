-- French Translation
-- Script ID: 1df9b6ddfb510f74b17138e909391a14
-- Migrated: 2025-09-11T14:25:34.262Z
...
godModeToggle = Tab:AddToggle("GodMode", {
    Title = "Gel des ennemis (mode Dieu)",
    Default = false,
...
ObjectiveSection:AddToggle("ObjectiveAutomation", {
    Title = "Remplir tous les objectifs",
    Default = false,
    Callback = function(Value)
...
ObjectiveSection:AddToggle("InstantCompleteV2", {
    Title = "Complétez immédiatement tous les objectifs V2 (école seulement)",
    Default = false,
    Callback = function(Value)
...
TeleportSection:AddSlider("HeightOffset", {
    Title = "Distance au-dessus de Zombie",
...
CombatSection:AddToggle("AllSkills", {
    Title = "Activer toutes les compétences",
    Default = false,
    Callback = function(Value)
        pcall(function()
...
CombatSection:AddToggle("InfPerk", {
    Title = "Activer une compétence spéciale",
    Default = false,
    Callback = function(Value)
        pcall(function()
            InfPerkActive = Value
...
doorActivatorToggle = CombatSection:AddToggle("DoorActivator", {
    Title = "Ouvrez toutes les portes",
    Default = false,
    Callback = function(Value)
