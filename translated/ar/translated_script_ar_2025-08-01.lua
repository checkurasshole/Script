...
local Tabs = {
    Main = Window:AddTab({ Title = "المهام الأساسية", Icon = "target" }),
    Shop = Window:AddTab({ Title = "تسوق", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "نصوص الخادم", Icon = "server" }),
...
do
    ...
    local PlotTracers = Tabs.Main:AddToggle("PlotTracers", {
        Title = "عرض جميع المؤقتات الأساسية",
    ...
    local ShowInvisible = Tabs.Main:AddToggle("ShowInvisible", {
        Title = "عرض اللاعبين غير المرئيين",
    ...
    Tabs.Watcher:AddButton({
        Title = "مسح القائمة التي تم العثور ...",
    ...
    InterfaceSection:AddKeybind("ToggleKeybind", {
        Title = "تبديل ربط مفاتيح واجهة المس...",
        Mode = "Toggle",
        Default = "LeftControl",
        Callback = function(Value)
        end,
