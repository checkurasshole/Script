...
-- Script ID: a6d00b7cca92b386d64742f8d38e4341
-- Migrated: 2025-09-11T13:21:23.052Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_ee0ea89103e82936__"))()
local SaveManager = loadstring(game:HttpGet("__URL_84962dd860634082__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_8a6e5dcedaeb8f4e__"))()
...
local UpgradesButton = Tabs.Main:AddButton({
    Title = "Teletransporte a actualizaciones",
    Callback = function()
        teleportToUpgrades()
    end
})
