...
-- Script ID: f7ea1ab77e6ce5627e62480f48640282
-- Created: 2025-10-09T15:01:40.852Z
-- Source: External API
...
local Tabs = {
    Discord = Window:AddTab({ Title = "Participe do Discord!", Icon = "link" }),
    Main = Window:AddTab({ Title = "Principal", Icon = "home" }),
    Plant = Window:AddTab({ Title = "Plantas", Icon = "leaf" }),
    Seeds = Window:AddTab({ Title = "Sementes", Icon = "sprout" }),
    Remove = Window:AddTab({ Title = "Remover", Icon = "trash-2" }),
...
local PlaceBestBrainrotsButton = Tabs.Main:AddButton({
    Title = "Coloque as melhores Brainrots",
    Callback = function()
        local args = {}
...
local AutoCollectMoneySlider = Tabs.Main:AddSlider("AutoCollectInterval", {
    Title = "Intervalo de Recolha Automática (Segundos)",
    Default = 5,
    Min = 1,
    Max = 60,
    Rounding = 0,
...
local AutoCollectMoneyToggle = Tabs.Main:AddToggle("AutoCollectMoney", {
    Title = "Recolher todo o dinheiro",
    Default = false,
    Callback = function(Value)
...
local TeleportPrisonButton = Tabs.Main:AddButton({
    Title = "Teletransportar para a prisão",
    Callback = function()
...
local SellAllBrainrotsButton = Tabs.Main:AddButton({
    Title = "Vender todas as Brainrots",
    Callback = function()
        local args = {
            [3] = true
        }
...
local PlatformSlider = Tabs.Shop:AddSlider("PlatformLevel", {
    Title = "Nível da plataforma (1-30)",
    Default = 1,
    Min = 1,
    Max = 30,
    Rounding = 0,
...
local BuyPlatformButton = Tabs.Shop:AddButton({
    Title = "Comprar a plataforma selecionada",
    Callback = function()
        local args = {
...
local BuyAllPlatformsButton = Tabs.Shop:AddButton({
    Title = "Compre todas as plataformas (1-30)",
    Callback = function()
        for i = 1, 30 do
            local args = {
                [1] = tostring(i)
...
local AutoBuyGearToggle = Tabs.Shop:AddToggle("AutoBuyGear", {
    Title = "Compra Automática de Equipamentos Selecionados",
    Default = false,
    Callback = function(Value)
        autoBuyGear = Value
        if Value then
...
local AutoBuySeedToggle = Tabs.Shop:AddToggle("AutoBuySeed", {
    Title = "Compra Automática de Sementes Selecionadas",
    Default = false,
    Callback = function(Value)
        autoBuySeed = Value
        if Value then
...
Tabs.Discord:AddParagraph({
    ...
    Content = "Junte-se à nossa comunidade do Discord para receber atualizações e suporte!"
})
