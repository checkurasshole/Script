...
-- Updated: 2026-09-09T02:29:34.752Z
...
MoveBox:AddSlider("se_walk",   { Text = "Vitesse de marche", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Réduire le lag", Default = false, Callback = function(v) setAntiLag(v) end })
