...
-- Script ID: 766fcaae53213799d170d393a9757b32
-- Migrated: 2025-09-11T13:21:17.719Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_57efc3bed851316a__"))()
local SaveManager = loadstring(game:HttpGet("__URL_41846f56d3c0f8ee__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_e9e5629709fad602__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "メイン", Icon = "activity" }),
    Shop = Window:AddTab({ Title = "ショップ", Icon = "shopping-cart" }),
    AntiAFK = Window:AddTab({ Title = "追放なし", Icon = "shield" })
}
