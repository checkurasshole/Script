...
local Tabs = {
    Main = Window:AddTab({ Title = "Funciones principales", Icon = "target" }),
    Shop = Window:AddTab({ Title = "Tienda", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "Scripts de servidor", Icon = "server" }),
...
do
    ...
    local PlotTracers = Tabs.Main:AddToggle("PlotTracers", {
        Title = "Mostrar todos los temporiza...",
    ...
    local ShowNames = Tabs.Main:AddToggle("ShowNames", {
        Title = "Mostrar nombres de reproduc...",
    ...
    local ShowInvisible = Tabs.Main:AddToggle("ShowInvisible", {
        Title = "Mostrar jugadores invisibles",
    ...
    Tabs.Main:AddButton({
        Title = "Dar todas las herramientas",
    ...
    local ServerInfoParagraph = Tabs.Server:AddParagraph({
        Title = "Detalles actuales del servidor",
    ...
    Tabs.Watcher:AddButton({
        Title = "Limpiar lista encontrada",
    ...
    Tabs.Watcher:AddButton({
        Title = "Enviar información del serv...",
    ...
    InterfaceSection:AddKeybind("ToggleKeybind", {
        Title = "Conmutar la combinación de ...",
        Mode = "Toggle",
        Default = "LeftControl",
        Callback = function(Value)
        end,
