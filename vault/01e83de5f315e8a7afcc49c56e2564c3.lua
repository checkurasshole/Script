...
-- Updated: 2026-08-31T18:12:58.450Z
...
M.EXPIRED_SUB   = "前往 combowick.com 获取密钥\n即可继续，无需等待。"
...
local function submitKey(key)
    ...
    if VaultModule and VaultModule.validateKey then
        ...
        Library:Notify({Title="密钥检查", Description="未找到有效密钥。请在网站上激活密钥，然后重新运行脚本。", Time=6})
    end
end
...
HelpGroup:AddLabel("❓ 如何获取高级版？\n前往 combowick.com/verify 获取密钥，然后粘贴到高级密钥选项卡。点一下即可。", true)
