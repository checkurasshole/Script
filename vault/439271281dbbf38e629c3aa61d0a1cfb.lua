...
-- Updated: 2026-09-09T02:29:40.360Z
...
MoveBox:AddSlider("se_walk",   { Text = "Tốc độ đi bộ", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Giảm lag", Default = false, Callback = function(v) setAntiLag(v) end })
