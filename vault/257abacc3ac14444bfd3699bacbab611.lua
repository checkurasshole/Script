...
-- Script ID: 257abacc3ac14444bfd3699bacbab611
-- Created: 2025-10-18T02:33:50.778Z
-- Source: External API
...
if VaultModule.compareVersions(VaultModule.CONFIG.VERSION, '1.3.2') <= 0 then
    Library:Notify({
        Title = 'Erforderliche Aktualisierung',
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("HWID-Informationen")
    ...
    LeftGroup:AddLabel({
        Text = "Der Zugang erfordert eine Validierung",
        DoesWrap = true,
    })
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("Schnelle Verknüpfungen")
    
    RightGroup:AddButton({
        Text = "- Schlüssel-Link erhalten",
        Func = function()
