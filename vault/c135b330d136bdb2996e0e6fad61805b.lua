...
-- Script ID: c135b330d136bdb2996e0e6fad61805b
-- Migrated: 2025-09-11T14:25:31.045Z
...
local MainTab = Window:CreateTab("Home", 6022668898)
local ServersTab = Window:CreateTab("Servers", 6031229361)
local UtilsTab = Window:CreateTab("Utils", 6034590631)
local SettingsTab = Window:CreateTab("Settings", 6035065170)
...
local CurrentServerSection = MainTab:CreateSection("Current Server")
...
-- Servers Tab
local FilterSection = ServersTab:CreateSection("Filters")
...
local ServerListSection = ServersTab:CreateSection("Server List")
...
-- Utils Tab
local UtilsSection = UtilsTab:CreateSection("External Server")
...
local QuickJoinSection = UtilsTab:CreateSection("Quick Join")

local JoinLowestButton = UtilsTab:CreateButton({
    Name = "Join Lowest Population Server",
    Callback = function()
        if #serverData == 0 then
            ShowNotification("No Data", "Please refresh server list first", 3)
            return
...
-- Settings Tab
local AutoRefreshSection = SettingsTab:CreateSection("Auto Refresh")
