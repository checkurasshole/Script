...
-- Script ID: 60eb611b53f2dda64eda61037fd21e44
-- Migrated: 2025-09-11T13:21:21.508Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_a00ff1f796de3e15__"))()
local SaveManager = loadstring(game:HttpGet("__URL_a9b47c5645b63c29__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_3304ae886d317fbc__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "หลัก", Icon = "activity" }),
    Shop = Window:AddTab({ Title = "ร้านขายของ", Icon = "shopping-cart" }),
    AntiAFK = Window:AddTab({ Title = "ไม่เตะ", Icon = "shield" })
}
