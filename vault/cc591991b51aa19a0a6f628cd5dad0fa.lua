...
-- Script ID: cc591991b51aa19a0a6f628cd5dad0fa
-- Migrated: 2025-09-11T13:21:14.815Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_7c0d89986035c4cb__"))()
local SaveManager = loadstring(game:HttpGet("__URL_eb30b40511b49985__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_8d2ec8c63d4bf778__"))()
...
local Tabs = {
    ...
    AntiAFK = Window:AddTab({ Title = "Sin patada", Icon = "shield" })
}
...
Tabs.Shop:AddToggle("AutoHead", {
    Title = "Cabezal de compra automática",
    Default = false,
    Callback = function(Value)
        autoBuyHead = Value
        if Value then
