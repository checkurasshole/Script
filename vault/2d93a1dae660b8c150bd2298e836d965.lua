...
-- Script ID: 2d93a1dae660b8c150bd2298e836d965
-- Created: 2025-10-19T14:58:15.627Z
-- Source: External API
...
local Tabs = {
    ...
    AutoWalk = Window:AddTab("Caça ao Alvo", "navigation"),
    Collect = Window:AddTab("Reivindicação de dinheiro", "dollar-sign"),
...
local ESPGroupBox = Tabs.Main:AddLeftGroupbox("Opções de Visualização", "eye")

ESPGroupBox:AddToggle("ESPToggle", {
    Text = "Mostrar marcadores de animais de estimação",
    Default = false,
    Callback = function(v)
        espEnabled = v
        if not v then
...
ESPGroupBox:AddToggle("TracerToggle", {
    Text = "Mostrar Linhas de Direção",
    Default = false,
    Callback = function(v)
        tracerEnabled = v
        if not v then
...
local AnimalGroupBox = Tabs.Main:AddRightGroupbox("Filtro PET", "filter")

AnimalGroupBox:AddDropdown("CommonDropdown", {
    Values = ComboWick.commonAnimals,
    Multi = true,
    Default = 1,
    Text = "Animais de estimação padrão",
...
AnimalGroupBox:AddDropdown("AdminDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "Admin/OG Animais de estimação",
    Callback = function(Value)
...
AnimalGroupBox:AddDropdown("BrainrotGodDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "BrainrotDeus Animais de Estimação",
    Searchable = true,
    Callback = function(Value)
...
AnimalGroupBox:AddDropdown("SecretDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "Animais de estimação secretos",
    Searchable = true,
    Callback = function(Value)
...
local AutoWalkGroupBox = Tabs.AutoWalk:AddLeftGroupbox("Definições de caça", "navigation")

AutoWalkGroupBox:AddToggle("AutoWalkToggle", {
    Text = "Comece a caçar animais de estimação",
    Default = false,
    Callback = function(v)
        autoWalkEnabled = v
        if v then
...
local CollectGroupBox = Tabs.Collect:AddLeftGroupbox("Definições de Reivindicação", "dollar-sign")

CollectGroupBox:AddToggle("CollectMoneyToggle", {
    Text = "Reivindicação automática",
    Default = false,
    Callback = function(v)
...
local StatusGroupBox = Tabs.Collect:AddRightGroupbox("CARGO", "activity")
