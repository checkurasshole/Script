...
-- Created: 2025-12-18T07:36:15.846Z
-- Source: External API
...
local Tabs = {
    Respawn = Window:AddTab("Автоматическое возрождение", "refresh-cw"),
    AimAssist = Window:AddTab("Помощник по AIM", "star"),
    Visuals = Window:AddTab("Визуал", "eye"),
    ["UI Settings"] = Window:AddTab("Настройки интерфейса", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("Автоматическое воспроизведение цикла")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("Версия 1 - Ручной ПК")
local AimbotV2Box = Tabs.AimAssist:AddRightGroupbox("Версия 2 - Автоматическая")
local TriggerBox = Tabs.AimAssist:AddLeftGroupbox("Автоматическая съемка")
local ESPBox = Tabs.Visuals:AddLeftGroupbox("Игрок ESP")
local TracerBox = Tabs.Visuals:AddRightGroupbox("Трассеры")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("Автозапуск", {
    Text = "Автоматическое воспроизведение цикла",
    Default = false,
    Tooltip = "Автоматическое возрождение после смерти",
})
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "Редактировать",
    Default = false,
    Tooltip = "Удерживайте правую кнопку мыши, чтобы заблокировать",
})
...
AimbotV1Box:AddToggle("ShowFOVV1", {
    Text = "Показать круг поля зрения",
    Default = false,
})
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "Редактировать",
    Default = false,
    Tooltip = "Кнопка автоматической блокировки нет",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "Редактировать",
    Default = false,
    Tooltip = "Автоматическая съемка при блокировке",
})
