...
-- Script ID: 1eb6056252de9bef7d881fc3cc90c925
-- Created: 2025-10-19T14:58:16.774Z
-- Source: External API
...
local Tabs = {
    Main = Window:AddTab("レーダー", "eye"),
    AutoWalk = Window:AddTab("ターゲットハント", "navigation"),
    Collect = Window:AddTab("マネークレーム", "dollar-sign"),
    PrivServer = Window:AddTab("サーバーモード", "server"),
    ["UI Settings"] = Window:AddTab("設定", "settings"),
}
...
local ESPGroupBox = Tabs.Main:AddLeftGroupbox("表示オプション", "eye")

ESPGroupBox:AddToggle("ESPトグル", {
    Text = "ペットのマーカーを表示",
    Default = false,
    Callback = function(v)
        espEnabled = v
...
local AnimalGroupBox = Tabs.Main:AddRightGroupbox("ペットフィルター", "filter")
...
local AutoWalkGroupBox = Tabs.AutoWalk:AddLeftGroupbox("ハント設定", "navigation")
...
local CollectGroupBox = Tabs.Collect:AddLeftGroupbox("クレーム設定", "dollar-sign")
...
local PrivServerGroupBox = Tabs.PrivServer:AddLeftGroupbox("プライベートサーバー", "server")
...
local MenuGroup = Tabs["UI Settings"]:AddLeftGroupbox("メニュー", "settings")
