...
-- Script ID: c5c8f05c230a380b6f6154c2cb2d08ae
-- Updated: 2025-12-18T07:40:32.065Z
...
local Tabs = {
    Respawn = Window:AddTab("Renascer Automático", "refresh-cw"),
    AimAssist = Window:AddTab("Assistente de Mira", "star"),
    Visuals = Window:AddTab("Visuais", "eye"),
    ["UI Settings"] = Window:AddTab("Configurações da UI", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("Loop de Jogo Automático")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("Versão 1 - PC Manual")
local AimbotV2Box = Tabs.AimAssist:AddRightGroupbox("Versão 2 - Automático")
local TriggerBox = Tabs.AimAssist:AddLeftGroupbox("Disparo Automático")
local ESPBox = Tabs.Visuals:AddLeftGroupbox("ESP de Jogador")
local TracerBox = Tabs.Visuals:AddRightGroupbox("Rastreadores")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("AutoPlay", {
    Text = "Loop de Jogo Automático",
    Default = false,
    Tooltip = "Renascer automaticamente ao morrer",
})
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "Ativar",
    Default = false,
    Tooltip = "Segure o botão direito para travar",
})
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "Ativar",
    Default = false,
    Tooltip = "Trava automática sem botão",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "Ativar",
    Default = false,
    Tooltip = "Disparo automático ao travar",
})
                ...
                if player ~= LocalPlayer and Module.isAlive(player) then
                    ...
                    if hrp then
                        ...
                        if onScreen then
                            ...
                            local fromPos
                            if Options.TracerPosition.Value == "Topo" then
                                fromPos = Vector2.new(Camera.ViewportSize.X / 2, 0)
                            elseif Options.TracerPosition.Value == "Meio" then
