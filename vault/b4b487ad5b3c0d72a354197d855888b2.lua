...
-- Script ID: b4b487ad5b3c0d72a354197d855888b2
-- Created: 2025-10-27T03:13:25.457Z
-- Source: External API
...
local MapConfigs = {
	{
		Name = "VeryFast",
		DisplayName = "Kẹo tự động nhanh nhất",
	...
	},
	{
		...
		DisplayName = "Găng Tay Mộ",
		Maze = Mazes:WaitForChild("Castle2"),
	},
	{
		Name = "PumpkinPathway",
		DisplayName = "Con đường bí ngô",
		Maze = Mazes:WaitForChild("Cornfield2"),
	},
}
...
if not moduleLoaded then
	...
	for i, mapConfig in ipairs(MapConfigs) do
		local toggleName = "Bật/tắt" .. mapConfig.Name
		
		MainBox:AddToggle(toggleName, {
			Text = mapConfig.DisplayName,
			Default = false,
			Tooltip = "Trang trại" .. mapConfig.Name,
		})
