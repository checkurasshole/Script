...
-- Script ID: c7426eca4f8f755ed6bc93aa78b0eacf
-- Migrated: 2025-09-11T13:21:23.799Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_939cf48ecd9f0b61__"))()
local SaveManager = loadstring(game:HttpGet("__URL_41d6e511312a475d__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_d64aa469c115073d__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Principales", Icon = "" })
}
...
local UpgradesButton = Tabs.Main:AddButton({
    Title = "Téléporter vers les mises à niveau",
    Callback = function()
        teleportToUpgrades()
    end
})
