...
-- Script ID: 51ba2cbf3ead4469177b9f5ea25ff8ff
-- Migrated: 2025-09-11T12:58:33.176Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_ad1060772b2c43cb__"))()
...
local Fluent = loadstring(game:HttpGet("__URL_eaa4e97a16a31d9f__"))()
...
TeleportSection:AddDropdown("DoorAvoidance", {
    Title = "Distância de Evitação da Porta",
