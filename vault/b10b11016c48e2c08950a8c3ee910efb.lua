...
-- Script ID: b10b11016c48e2c08950a8c3ee910efb
-- Created: 2025-10-19T14:58:18.221Z
-- Source: External API
...
local Tabs = {
    ...
    AutoWalk = Window:AddTab("Target Hunt", "navigation"),
    Collect = Window:AddTab("Pag - claim ng Pera", "dollar-sign"),
    PrivServer = Window:AddTab("Mode ng Server", "server"),
...
local ESPGroupBox = Tabs.Main:AddLeftGroupbox("Mga Pagpipilian sa Display", "eye")

ESPGroupBox:AddToggle("ESPToggle", {
    Text = "Ipakita ang Mga Marker ng Alagang Hayop",
    Default = false,
    Callback = function(v)
        espEnabled = v
        if not v then
...
ESPGroupBox:AddToggle("TracerToggle", {
    Text = "Ipakita ang mga Linya ng Direksyon",
    Default = false,
    Callback = function(v)
        tracerEnabled = v
        if not v then
...
local AnimalGroupBox = Tabs.Main:AddRightGroupbox("Filter ng Alagang Hayop", "filter")

AnimalGroupBox:AddDropdown("CommonDropdown", {
    Values = ComboWick.commonAnimals,
    Multi = true,
    Default = 1,
    Text = "Mga Standard na Alagang Hayop",
...
AnimalGroupBox:AddDropdown("BrainrotGodDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "BrainrotGod Mga Alagang Hayop",
    Searchable = true,
    Callback = function(Value)
...
AnimalGroupBox:AddDropdown("SecretDropdown", {
    ...
    Multi = true,
    Default = 1,
    Text = "Mga Lihim na Alagang Hayop",
    Searchable = true,
    Callback = function(Value)
...
local AutoWalkGroupBox = Tabs.AutoWalk:AddLeftGroupbox("Mga Setting ng Hunt", "navigation")

AutoWalkGroupBox:AddToggle("AutoWalkToggle", {
    Text = "Simulan ang Pet Hunt",
    Default = false,
    Callback = function(v)
        autoWalkEnabled = v
        if v then
...
local CollectGroupBox = Tabs.Collect:AddLeftGroupbox("Mga Setting ng Claim", "dollar-sign")

CollectGroupBox:AddToggle("Email: info@collectmoneytoggle.com", {
    Text = "Auto Claim",
    Default = false,
    Callback = function(v)
...
local StatusGroupBox = Tabs.Collect:AddRightGroupbox("Estado", "activity")
...
local PrivServerGroupBox = Tabs.PrivServer:AddLeftGroupbox("Pribadong server", "server")
