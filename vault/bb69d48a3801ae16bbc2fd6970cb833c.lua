...
-- Script ID: bb69d48a3801ae16bbc2fd6970cb833c
-- Migrated: 2025-09-11T14:25:41.083Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_344ec405d9de28df__"))()
local SaveManager = loadstring(game:HttpGet("__URL_05c5846956237a67__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_251dc7227e24ef86__"))()
...
toggleButton.Name = "Conmutar botón"
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "Objetos despojados", Icon = "package" })
}
...
local BuildToolsDropdown = Tabs.Spawn:AddDropdown("BuildToolsDropdown", {
    Title = "Seleccionar herramienta de compilación",
    Values = BuildTools,
    Multi = false,
    Default = 1,
})
