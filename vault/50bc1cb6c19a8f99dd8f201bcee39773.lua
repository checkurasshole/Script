...
-- Created: 2025-12-18T07:36:14.772Z
-- Source: External API
...
AutoPlayBox:AddToggle("Autoplay", {
    Text = "Auto Play Loop",
    Default = false,
    Tooltip = "Auto respawn sa kamatayan",
})
...
AimbotV1Box:AddToggle("AimbotV1s chat", {
    Text = "I-enable",
    Default = false,
    Tooltip = "Pindutin nang matagal ang right click para i - lock",
})
...
AimbotV1Box:AddSlider("AimbotV1FOVs Chat", {
    Text = "FOV Radius",
    Default = 200,
    Min = 50,
    Max = 500,
...
AimbotV1Box:AddToggle("S1adkayaPara", {
...
AimbotV2Box:AddToggle("AimbotV2s Chat", {
    Text = "I-enable",
    Default = false,
    Tooltip = "Auto lock walang pindutan",
})
...
ESPBox:AddToggle("Email: info@namesep.com", {
    Text = "Distansya ng Pangalan",
    Default = false,
})
...
TracerBox:AddToggle("Mga Tagasubaybay", {
    Text = "I-enable",
    Default = false,
})
...
TracerBox:AddDropdown("TracerPosition", {
    Text = "Simulan ang Posisyon",
    Values = {"Top", "Middle", "Bottom"},
    Default = 3,
})

TracerBox:AddSlider("TracerThickness", {
    Text = "At hintayin itong lumapot",
    Default = 1,
    Min = 1,
    Max = 5,
    Rounding = 0,
