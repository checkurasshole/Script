...
-- Script ID: 4f6141a5941891921fdbb411227f1f19
-- Migrated: 2025-09-11T13:21:00.020Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_c7abd9edb2607eba__"))()
...
local ShopTab = Window:AddTab({ Title = "Loja", Icon = "" })
...
Tab:AddToggle("AutoFarm", {Title = "Auto Farm", Default = false}):OnChanged(function(value)
...
Tab:AddToggle("AutoSell", {Title = "Venda Automática", Default = false}):OnChanged(function(value)
...
ShopTab:AddParagraph({
    ...
    Content = "Adicione os seus próprios artigos à compra automática"
})
...
ShopTab:AddButton({
    Title = "Adicionar nome do artigo da loja",
