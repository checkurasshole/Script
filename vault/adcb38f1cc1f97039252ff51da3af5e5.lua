...
-- Script ID: adcb38f1cc1f97039252ff51da3af5e5
-- Created: 2025-10-01T19:35:11.133Z
-- Source: External API
...
ScreenGui.Name = "L'Even UIToggleBtn"
...
local function handleBuildStatus(status, data)
    ...
    elseif status == "cancelled" then
        WindUI:Notify({
            Title = "Bâtiment annulé",
            Content = "Arrêt à" .. data.wallNumber,
            Icon = "x-circle",
            Duration = 3
        })
    elseif status == "placement_failed" then
        WindUI:Notify({
            Title = "ARRÊT DE LA PLACE",
            Content = "Mur" .. data.wallNumber,
            Icon = "alert-triangle",
            Duration = 10
        })
    elseif status == "walls_not_appearing" then
        WindUI:Notify({
            Title = "IL NE S'APPLIQUE PAS",
            Content = "",
            Icon = "alert-triangle",
            Duration = 10
        })
...
local MainTab = Window:Tab({ Title = "Quête principale", Icon = "zap" })
local DiamondFarmTab = Window:Tab({ Title = "Ferme du diamant", Icon = "gem" })
local CollectorTab = Window:Tab({ Title = "Collecteur d'objets", Icon = "package" })
local PivotTab = Window:Tab({ Title = "Feu principal", Icon = "move" })
local CombatTab = Window:Tab({ Title = "Système de combat", Icon = "sword" })
local CookingTab = Window:Tab({ Title = "Cuisine et aliments", Icon = "flame" })
local VisualTab = Window:Tab({ Title = "Outils visuels", Icon = "eye" })

-- WINDUI TABS (BELOW)
local LogWallTab = Window:Tab({ Title = "Murs de bûcherons", Icon = "shield" })
local PlantHouseTab = Window:Tab({ Title = "Plantes/Maisons", Icon = "home" })
...
MainTab:Toggle({
    Title = "Débloquer la carte + Obtenir des enfants",
    Desc = "",
    Value = false,
...
DiamondFarmTab:Button({
    Title = "Système de production de diamants",
    Desc = "",
    Icon = "info",
    Callback = function() end
})
...
diamondFarmToggle = DiamondFarmTab:Toggle({  -- Store the toggle reference
    ...
    Callback = function(Value)
        ...
        if Value then
            ...
            if success then
                WindUI:Notify({
                    Title = "Exploitation diamantaire chargée",
                    Content = "Script activé avec succès",
                    Icon = "gem",
                    Duration = 3
                })
            else
                WindUI:Notify({
                    Title = "Échec de la charge",
                    Content = "Impossible de charger le script de la ferme de diamant",
                    Icon = "x-circle",
                    Duration = 5
                })
            end
            ...
            WindUI:Notify({
                Title = "La ferme de diamants est handicapée",
                Content = "Désactivez - le script peut être toujours en cours d'exécution",
                Icon = "info",
                Duration = 2
            })
        end
...
-- =====================
CollectorTab:Button({
    Title = "Système de collecte des articles",
...
local PlayerDropdown = CollectorTab:Dropdown({
    Title = "Recueillir des éléments vers le lecteur",
    Desc = "",
    ...
    Callback = function(Value)
        ...
        WindUI:Notify({
            Title = "Le joueur cible a changé",
            Content = "Les articles seront collectés à l'adresse suivante:" .. Value,
            Duration = 2
        })
    end
})
...
local ItemDropdown = CollectorTab:Dropdown({
    Title = "Sélectionnez le type d'élément",
    Desc = "",
...
CollectorTab:Button({
    Title = "Recueillir les éléments sélectionnés",
    Desc = "",
    Icon = "download",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
        if selectedItem then
            ...
            WindUI:Notify({
                Title = "Aucune sélection n'a été effectuée",
                Content = "Veuillez d'abord sélectionner le type d'élément",
                Duration = 2
            })
        end
    end
...
CollectorTab:Toggle({
    Title = "Détection de la poitrine de diamant",
...
CollectorTab:Toggle({
    Title = "Déplacer automatiquement de nouveaux éléments",
...
CollectorTab:Toggle({
    Title = "Pièces de collecte automatique",
...
CollectorTab:Dropdown({
    Title = "Méthode de collecte des pièces",
    Desc = "",
...
-- =====================
PivotTab:Button({
    Title = "Collection principale d'incendie",
    Desc = "",
    Icon = "info",
    Callback = function() end
})
...
PivotTab:Dropdown({
    Title = "Position de recouvrement",
    Desc = "",
...
PivotTab:Button({
    Title = "Téléporter à la position choisie",
    Desc = "",
    Icon = "map-pin",
    Callback = function()
...
PivotTab:Toggle({
    Title = "Éparpiller les objets autour",
    Desc = "",
    Value = true,
    Callback = function(Value)
...
PivotTab:Slider({
    Title = "Ne dispersez pas les éléments",
    Desc = "",
    Value = {
        Min = 1,
        Max = 15,
...
-- =====================
CombatTab:Button({
    Title = "Détection automatique des armes",
...
CombatTab:Dropdown({
    Title = "Sélectionner le type d'arbre",
    Desc = "",
...
CombatTab:Button({
    Title = "Toutes les invites instantanées",
    Desc = "",
    Icon = "zap",
    Callback = function()
        local modified = 0
        ...
        WindUI:Notify({
            Title = "Mise à jour des délais",
            Content = "Jeu" .. modified .. " prompts to instant",
            Duration = 2
        })
    end
})
...
CookingTab:Dropdown({
    Title = "Aliments pour l'auto-alimentation",
    Desc = "",
...
CookingTab:Toggle({
    Title = "Système de cuisson automatique",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
CookingTab:Toggle({
    Title = "Apporter de la nourriture après cuisson",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
VisualTab:Toggle({
    Title = "Mettre en surbrillance le nom du joueur",
    Desc = "",
    Value = false,
    Callback = function(Value)
...
VisualTab:Button({
    Title = "Copier le Script de Téléportage de Jeu",
    Desc = "",
    Icon = "copy",
    Callback = function()
...
LogWallTab:Button({
    Title = "MODÈLE DE BETA - BOUTES D'EXPÉDITION",
    Desc = "",
    Icon = "alert-triangle",
    Color = Color3.fromHex("#ff4830"),
    Callback = function() end
...
resourceButton = LogWallTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Mise à jour des ressources",
            Content = "",
            Icon = "refresh-cw",
            Duration = 2
        })
...
LogWallTab:Button({
    Title = "Rafraîchir les ressources",
    Desc = "",
    Icon = "refresh-cw",
    Callback = function()
        updateLogWallResourceDisplay()
...
maxZoomSlider = LogWallTab:Slider({
    Title = "Distance maximale de zoom",
    Desc = "",
    Value = {
        Min = 50,
        Max = 2000,
...
LogWallTab:Button({
    Title = "CAMP DE CIRCULATION AÉRIENNE",
    Desc = "",
    Icon = "zap",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
...
plantResourceButton = PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Mise à jour des ressources",
            Content = "Le décompte des articles a été actualisé.",
            Icon = "refresh-cw",
            Duration = 2
        })
    end
...
PlantHouseTab:Button({
    Title = "Utiliser la position du joueur",
    Desc = "",
    Icon = "map-pin",
    Callback = function()
        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            ...
            WindUI:Notify({
                ...
                Content = "Régler à la position du joueur",
                Icon = "map-pin",
                Duration = 2
            })
        end
...
plantBuildSpeedSlider = PlantHouseTab:Slider({
    Title = "Vitesse de construction (Fast)",
    Desc = "",
    Value = {
        Min = 5,
        Max = 50,
...
PlantHouseTab:Button({
    Title = "BÂTIMENT D'ÉTABLISSEMENT",
    Desc = "",
    Icon = "play",
    Color = Color3.fromHex("#30ff6a"),
    Callback = function()
        if PlantHouseBuilder.config.isBuilding then
            WindUI:Notify({
                ...
                Content = "S'il vous plaît attendre que la construction actuelle finisse",
                Icon = "alert-circle",
                Duration = 3
            })
            return
        ...
        if #allPoints > 0 then
            ...
            if available < #allPoints then
                WindUI:Notify({
                    Title = "Pas assez d'articles !",
                    Content = "Besoin" .. (#allPoints - available) .. " more items",
                    Icon = "x-circle",
                    Duration = 5
                })
                return
            ...
            WindUI:Notify({
                Title = "Le bâtiment a commencé !",
                Content = "Bâtiment" .. #allPoints .. " blocks",
                Icon = "hammer",
                Duration = 3
            })
        else
            WindUI:Notify({
                Title = "Rien sélectionné",
                Content = "Veuillez sélectionner une forme de plante ou un type de maison",
                Icon = "alert-triangle",
                Duration = 3
            })
        end
...
PlantHouseTab:Button({
    ...
    Callback = function()
        ...
        WindUI:Notify({
            Title = "Bâtiment arrêté",
            Content = "Toutes les constructions en attente annulées",
            Icon = "square",
            Duration = 2
        })
    end
...
ConfigTab:Button({
    ...
    Callback = function()
        if configNameInput == "" then
            WindUI:Notify({
                Title = "Erreur",
                Content = "Saisissez d'abord un nom de config",
                Icon = "alert-circle",
                Duration = 3
            })
            return
...
ConfigTab:Button({
    Title = "Enregistrer la configuration actuelle",
...
ConfigTab:Button({
    Title = "Rafraîchir la liste des configs",
...
ConfigTab:Button({
    Title = "Charger & Exécuter (Log Walls)",
    ...
    Callback = function()
        ...
        if not success then
            ...
            WindUI:Notify({
                Title = "Exécuter des murs de bûcherons",
                Content = selectedConfig,
                Icon = "zap",
                Duration = 2
            })
...
autoLoadToggle = ConfigTab:Toggle({
    Title = "Charger automatiquement lors du démarrage",
...
autoLoadConfigDropdown = ConfigTab:Dropdown({
    Title = "Charger automatiquement la configuration",
    ...
    Callback = function(v)
        ...
        saveAutoLoadSettings()
        WindUI:Notify({
            Title = "Jeu de configuration de chargement automatique",
            Content = v,
            Icon = "check-circle",
            Duration = 2
        })
...
SettingsTab:Toggle({
    Title = "Éparpillement d'éléments",
    Desc = "",
    Value = true,
    Callback = function(Value)
        Module.Vars.SCATTER_ENABLED = Value
...
SettingsTab:Input({
    ...
    Callback = function(Value)
        ...
        if numValue and numValue >= 0 and numValue <= 1000 then
            ...
            WindUI:Notify({
                Title = "Ensemble de limites BigTree",
...
WindUI:Notify({
    Title = "Hub d'outil ultime chargé!",
    Content = "Toutes les fonctionnalités sont prêtes",
    Icon = "check-circle",
    Duration = 3
})
