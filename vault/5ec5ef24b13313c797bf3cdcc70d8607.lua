...
-- Updated: 2026-09-09T02:29:42.965Z
...
MoveBox:AddSlider("se_walk",   { Text = "Velocidad de caminata", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Reducir lag", Default = false, Callback = function(v) setAntiLag(v) end })
