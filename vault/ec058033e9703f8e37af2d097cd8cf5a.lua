...
-- Created: 2025-12-18T07:36:15.301Z
-- Source: External API
...
local Tabs = {
    Respawn = Window:AddTab("เกิดใหม่โดยอัตโนมัติ", "refresh-cw"),
    AimAssist = Window:AddTab("ผู้ช่วย AIM", "star"),
    Visuals = Window:AddTab("ทัศนศิลป์", "eye"),
    ["UI Settings"] = Window:AddTab("การตั้งค่า UI", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("เล่นวนซ้ำอัตโนมัติ")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("เวอร์ชัน 1 - พีซีธรรมดา")
...
local ESPBox = Tabs.Visuals:AddLeftGroupbox("ผู้เล่น ESP")
local TracerBox = Tabs.Visuals:AddRightGroupbox("ตัวติดตาม")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("AutoPlay", {
    Text = "เล่นวนซ้ำอัตโนมัติ",
    Default = false,
    Tooltip = "การเกิดใหม่โดยอัตโนมัติเมื่อเสียชีวิต",
})
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "เปิดใช้งาน",
    Default = false,
    Tooltip = "กดคลิกขวาค้างไว้เพื่อล็อก",
})
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "เปิดใช้งาน",
    Default = false,
    Tooltip = "ปุ่มล็อคอัตโนมัติไม่มี",
})
...
TriggerBox:AddToggle("TriggerBot", {
    Text = "เปิดใช้งาน",
    Default = false,
    Tooltip = "การถ่ายภาพอัตโนมัติเมื่อล็อก",
})

TriggerBox:AddSlider("TriggerDelay", {
    Text = "ความล่าช้า (มิลลิวินาที)",
    Default = 50,
    Min = 0,
    Max = 500,
    Rounding = 0,
...
TracerBox:AddDropdown("TracerPosition", {
    Text = "À¸ªà¸£à¹à¸²à¸à¸£à¸¹à¸à¸ à¸²à¸à¸ªà¸³à¸«à¸£à¸±à¸à¸ à¸²à¸à¸à¸´à¹à¸",
