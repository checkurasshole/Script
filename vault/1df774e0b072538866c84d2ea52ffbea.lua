...
-- Script ID: 1df774e0b072538866c84d2ea52ffbea
-- Created: 2025-10-18T02:37:54.345Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local LeftGroup = Tabs.Validation:AddLeftGroupbox("HWID Information")
    ...
    LeftGroup:AddLabel({
        Text = "Access requires validation",
        DoesWrap = true,
    })
    ...
    local RightGroup = Tabs.Validation:AddRightGroupbox("Quick Links")
