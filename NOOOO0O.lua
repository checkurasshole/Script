spawn(function()
            for i = 1, 15 do
                if button.Parent then
                    strokeGradientBtn.Rotation = strokeGradientBtn.Rotation + 24
                    wait(0.03)
                end
            end
...
local scripts = {
    ["English"] = "https://v0-supabase-secure-storage.vercel.app/api/script/0da0a7cdc5b561928e5cd1084bd49ca0",
