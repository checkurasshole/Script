...
-- Updated: 2026-09-12T04:11:40.119Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "No vender (rarezas)" })
...
local function serverHop(pref)
    ...
    notify(("Hop: %d servidores encontrados"):format(#list))
    local idx = 0
    local conn
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("No se detectó golpe en 25s"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Fallo al agarrar el objetivo"); unlockMove(); return end
            stolen = stolen + 1
