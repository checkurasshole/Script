...
-- Updated: 2026-09-12T04:11:37.808Z
...
Box:AddDropdown("se_keepsell", { Values = RARITY_LIST, Multi = true, AllowNull = true, Default = { Legendary = true, Mythic = true, Rainbow = true, Cosmic = true, Exclusive = true, Secret = true, Exotic = true, Eternal = true, Limited = true, Superior = true, Divine = true }, Text = "Không bán (độ hiếm)" })
...
local function serverHop(pref)
    ...
    notify(("Hop: tìm thấy %d máy chủ"):format(#list))
    local idx = 0
    local conn
...
task.spawn(function()
    while RUNNING do
        local ok = pcall(function()
            ...
            if not hit then setStatus("Không phát hiện đòn trong 25 giây"); unlockMove(); return end
            ...
            if not haveIt() then setStatus("Lấy mục tiêu thất bại"); unlockMove(); return end
            stolen = stolen + 1
