-- Script_1754579587349
-- Script ID: 8d70c58cd263425b797e624be7cfc278
-- Migrated: 2025-09-11T12:58:13.522Z
...
local Rayfield = loadstring(game:HttpGet('__URL_4d9294b4db33a701__'))()
...
local Window = Rayfield:CreateWindow({
    Name = "COMBO_DOCHT",
    Icon = 12345678901,
    LoadingTitle = "Viel Spaß!",
    LoadingSubtitle = "Von COMBO_aber",
    Theme = "Ocean",
    ConfigurationSaving = {
        Enabled = true,
...
local Tab = Window:CreateTab("Haupt", nil)
local AmberTab = Window:CreateTab("Bernsteinkollektion", nil)
local UtilityTab = Window:CreateTab("Versorgung", nil)

-- Utility Tab (Anti-Void)
UtilityTab:CreateSection("Anti-Void")
UtilityTab:CreateToggle({
    Name = "Anti-Void aktivieren",
    CurrentValue = false,
    Flag = "AntiVoidToggle",
...
UtilityTab:CreateButton({
    Name = "Fake Out (Teleportieren unt...",
    Callback = function()
        fakeOut()
    end
})
...
Tab:CreateSection("Tier-Autofarm")
Tab:CreateToggle({
    Name = "ESP-Name aktivieren",
    CurrentValue = false,
    Flag = "ESPNameToggle",
    Callback = function(value)
        toggleESP(value)
...
Tab:CreateToggle({
    Name = "Teleportiere zu Ziegen-NSCs",
    CurrentValue = false,
...
Tab:CreateSection("Player AutoFarm")
Tab:CreateToggle({
    Name = "An Spieler teleportieren",
    CurrentValue = false,
    Flag = "TeleportToggle",
    Callback = function(value)
        teleporting = value
...
Tab:CreateToggle({
    Name = "Sich bewegende Spieler anvi...",
    CurrentValue = true,
...
Tab:CreateToggle({
    Name = "Zielt weiterhin auf Spieler ab",
    CurrentValue = true,
...
Tab:CreateSlider({
    Name = "Entfernung hinter dem Feind",
    Range = {1, 100},
    Increment = 1,
    Suffix = "studs",
    CurrentValue = 5,
...
AmberTab:CreateToggle({
    Name = "Bernsteinkollektion aktivieren",
    CurrentValue = false,
