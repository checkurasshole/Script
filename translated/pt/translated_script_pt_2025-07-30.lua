...
-- Main Tab
local MainTab = Window:CreateTab("Controles do carro", "car")
...
-- Upgrades Tab
local UpgradesTab = Window:CreateTab("Actualizações", "trending-up")

-- Brainrot Speed Toggle
local BrainrotToggle = UpgradesTab:CreateToggle({
   Name = "Velocidade do Brainrot",
   CurrentValue = false,
   Flag = "BrainrotToggle",
   Callback = function(Value)
...
local MoneyToggle = UpgradesTab:CreateToggle({
   Name = "Multiplicador de dinheiro",
   CurrentValue = false,
   Flag = "MoneyToggle",
   Callback = function(Value)
