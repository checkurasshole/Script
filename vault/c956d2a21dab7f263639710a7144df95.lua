-- Script_1754171869361
-- Script ID: c956d2a21dab7f263639710a7144df95
-- Migrated: 2025-09-11T12:58:10.648Z
-- Auto-migrated from encrypted storage to GitHub

loadstring(game:HttpGet("__URL_d0221022bd8d480d__"))()
local Fluent = loadstring(game:HttpGet("__URL_9c22092dfa01ce29__"))()
local SaveManager = loadstring(game:HttpGet("__URL_bbf8e985107b4d29__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_e8fc213b375d06b3__"))()
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main Functions", Icon = "target" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shopping-cart" }),
    Server = Window:AddTab({ Title = "Server Scripts", Icon = "server" }),
...
local ESP_GITHUB_URL = '__URL_2cd58c36a70d5a54__'
local AUTO_LOCK_SCRIPT_URL = '__URL_2c130003499cf9cd__'
...
local function addESP(animal, index)
    ...
    highlight.Name = "TopAnimalHighlight"..index
...
do
    ...
    local WebhookInput = Tabs.Watcher:AddInput("WebhookInput", {
        ...
        Placeholder = "__URL_d9f4b2c314191f7e__",
        Numeric = false,
        Finished = true,
        Callback = function(Value)
