...
-- Script ID: 40f9528778d2bac79c9a59e286a9d05c
-- Migrated: 2025-09-11T14:25:39.658Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_88eaf04ffe15ae46__"))()
local SaveManager = loadstring(game:HttpGet("__URL_04797364e5ad8282__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_d9f464d8ee362266__"))()
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "Spawn Items", Icon = "package" })
}
