...
-- Script ID: 8776f5b15d798d86b8aa8708b0980024
-- Created: 2025-12-22T16:26:09.518Z
-- Source: External API
-- Auto-generated by Lua Script Vault

-- Main Script
-- Tải mô-đun và tạo giao diện
...
-- Create Tabs
local Tabs = {
    Main = Window:AddTab("Trang chủ", "shopping-cart"),
}

-- Main Purchases Box
local MainBox = Tabs.Main:AddLeftGroupbox("Mua hàng", "package")
...
-- Manual Purchase Box
local ManualBox = Tabs.Main:AddRightGroupbox("Mua hàng thủ công", "edit")
