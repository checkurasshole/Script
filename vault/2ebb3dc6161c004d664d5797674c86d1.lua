...
-- Script ID: 2ebb3dc6161c004d664d5797674c86d1
-- Created: 2025-10-10T17:13:45.205Z
-- Source: External API
...
local Tabs = {
    ...
    PrivateServer = Window:AddTab({ Title = "Serveur privé", Icon = "lock" })
}
...
local saveFileName = "InfMoneyActivé_" .. LocalPlayer.UserId .. ".txt"
...
Tabs.PrivateServer:AddButton({
    Title = "Rejoignez le serveur privé",
    Callback = function()
