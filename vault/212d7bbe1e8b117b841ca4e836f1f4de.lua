...
-- Script ID: 212d7bbe1e8b117b841ca4e836f1f4de
-- Created: 2025-10-09T15:01:39.547Z
-- Source: External API
...
local Tabs = {
    Discord = Window:AddTab({ Title = "¡Únete a Discord!", Icon = "link" }),
    Main = Window:AddTab({ Title = "Principal", Icon = "home" }),
    Plant = Window:AddTab({ Title = "Plantas", Icon = "leaf" }),
    Seeds = Window:AddTab({ Title = "Semillas", Icon = "sprout" }),
    Remove = Window:AddTab({ Title = "Eliminar", Icon = "trash-2" }),
    Shop = Window:AddTab({ Title = "Tienda", Icon = "shopping-cart" }),
    Events = Window:AddTab({ Title = "Detector meteorológico", Icon = "zap" }),
...
local TargetBrainrotDropdown = Tabs.Main:AddDropdown("TargetBrainrot", {
    Title = "Tipo Brainrot de destino",
...
local PlaceBestBrainrotsButton = Tabs.Main:AddButton({
    Title = "Colocar las mejores Brainrots",
    Callback = function()
        local args = {}
...
local AutoCollectMoneySlider = Tabs.Main:AddSlider("AutoCollectInterval", {
    Title = "Intervalo de recogida automática (segundos)",
    Default = 5,
    Min = 1,
    Max = 60,
    Rounding = 0,
...
local TeleportPrisonButton = Tabs.Main:AddButton({
    Title = "Teletransporte a la prisión",
    Callback = function()
...
local SellAllBrainrotsButton = Tabs.Main:AddButton({
    Title = "Vender todos los Brainrots",
    Callback = function()
        local args = {
            [3] = true
        }
...
local PlatformSlider = Tabs.Shop:AddSlider("PlatformLevel", {
    Title = "Nivel de plataforma (1-30)",
    Default = 1,
    Min = 1,
    Max = 30,
    Rounding = 0,
...
local BuyPlatformButton = Tabs.Shop:AddButton({
    Title = "Comprar la plataforma seleccionada",
    Callback = function()
        local args = {
...
local BuyAllPlatformsButton = Tabs.Shop:AddButton({
    Title = "Comprar todas las plataformas (1-30)",
    Callback = function()
        for i = 1, 30 do
            local args = {
                [1] = tostring(i)
...
local AutoBuyGearToggle = Tabs.Shop:AddToggle("AutoBuyGear", {
    Title = "Comprar automáticamente el engranaje seleccionado",
    Default = false,
    Callback = function(Value)
        autoBuyGear = Value
        if Value then
...
local BuyAllGearsButton = Tabs.Shop:AddButton({
    Title = "Comprar todos los engranajes",
    Callback = function()
...
local AutoBuySeedToggle = Tabs.Shop:AddToggle("AutoBuySeed", {
    Title = "Auto comprar semilla seleccionada",
    Default = false,
    Callback = function(Value)
        autoBuySeed = Value
        if Value then
...
local BuyAllSeedsButton = Tabs.Shop:AddButton({
    Title = "Comprar todas las semillas",
    Callback = function()
...
Tabs.Settings:AddButton({
    Title = "Reiniciar el seguimiento",
    Callback = function()
        PlantingModule.clearOccupiedSpots()
        PlantingModule.plantLimitReached = false
        Fluent:Notify({
...
Tabs.Discord:AddParagraph({
    ...
    Content = "¡Únete a nuestra comunidad de Discord para recibir actualizaciones y soporte!"
})

Tabs.Discord:AddParagraph({
    Title = "Invitar enlace",
    Content = "https://discord.gg/BUzsQPEY"
})

Tabs.Discord:AddButton({
    Title = "Copiar enlace de disco",
    Callback = function()
