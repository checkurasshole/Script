...
-- Script ID: 1adf1c1740d02ad3db28b6d21998cb87
-- Created: 2026-01-03T00:53:11.461Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local Tabs = {
        ...
        Info = Window:AddTab("Informationen und Links", "info")
    }
        
    local validationComplete = false
    local validationSuccess = false
    
    local MainGroup = Tabs.Validation:AddLeftGroupbox("Geben Sie Ihren API-Schlüssel ein")
