...
-- Script ID: 33c44e51742a4281ea6b69091d0e4088
-- Created: 2025-10-09T15:01:42.113Z
-- Source: External API
...
local Tabs = {
    Discord = Window:AddTab({ Title = "Tham gia Discord!", Icon = "link" }),
    Main = Window:AddTab({ Title = "Chính", Icon = "home" }),
    Plant = Window:AddTab({ Title = "Thực vật", Icon = "leaf" }),
    Seeds = Window:AddTab({ Title = "Hạt", Icon = "sprout" }),
    Remove = Window:AddTab({ Title = "Xóa", Icon = "trash-2" }),
    Shop = Window:AddTab({ Title = "Mua sắm", Icon = "shopping-cart" }),
    Events = Window:AddTab({ Title = "Máy dò thời tiết", Icon = "zap" }),
...
local AutoCollectMoneySlider = Tabs.Main:AddSlider("AutoCollectInterval", {
    Title = "Khoảng thời gian Thu thập Tự động (Giây)",
    Default = 5,
    Min = 1,
    Max = 60,
    Rounding = 0,
...
local TeleportPrisonButton = Tabs.Main:AddButton({
    Title = "Dịch chuyển tức thời đến nhà tù",
    Callback = function()
...
PlantToggle:OnChanged(function(Value)
    if Value then
        if #selectedPlantRarities == 0 then
            Fluent:Notify({
                Title = "Không có vùng chọn nào cả",
                Duration = 3
            })
...
local BuyAllPlatformsButton = Tabs.Shop:AddButton({
    Title = "Mua tất cả các nền tảng (1-30)",
    Callback = function()
        for i = 1, 30 do
            local args = {
                [1] = tostring(i)
...
local AutoBuyGearToggle = Tabs.Shop:AddToggle("AutoBuyGear", {
    Title = "Tự động mua thiết bị đã chọn",
    Default = false,
    Callback = function(Value)
        autoBuyGear = Value
        if Value then
...
local BuyAllGearsButton = Tabs.Shop:AddButton({
    Title = "Mua tất cả các bánh răng",
    Callback = function()
...
local AutoBuySeedToggle = Tabs.Shop:AddToggle("AutoBuySeed", {
    Title = "Tự động mua hạt giống đã chọn",
    Default = false,
    Callback = function(Value)
        autoBuySeed = Value
        if Value then
...
Tabs.Settings:AddButton({
    Title = "Thiết lập lại chức năng theo dõi",
    Callback = function()
        PlantingModule.clearOccupiedSpots()
        PlantingModule.plantLimitReached = false
        Fluent:Notify({
...
Tabs.Discord:AddParagraph({
    ...
    Content = "Tham gia cộng đồng Discord của chúng tôi để được cập nhật và hỗ trợ!"
})
...
Tabs.Discord:AddButton({
    Title = "Sao chép liên kết Discord",
    Callback = function()
