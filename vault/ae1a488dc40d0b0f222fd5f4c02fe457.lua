...
-- Updated: 2026-09-09T02:29:46.034Z
...
MoveBox:AddSlider("se_walk",   { Text = "Kecepatan Berjalan", Default = 409, Min = 0, Max = 1000, Rounding = 0 })
...
ProtBox:AddToggle("se_antilag", { Text = "Kurangi Lag", Default = false, Callback = function(v) setAntiLag(v) end })
