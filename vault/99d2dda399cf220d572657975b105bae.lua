...
-- Updated: 2026-01-03T00:55:31.427Z
...
if VaultModule.compareVersions(VaultModule.CONFIG.VERSION, '1.3.2') <= 0 then
    Library:Notify({
        Title = '更新が必要です',
        Description = 'このバージョンはサポートされていません。最新バージョンに更新してください。',
        Time = 10,
    })
    return {
        success = false,
        error = "古いバージョン",
        message = "このバージョンはサポートされていません"
    }
end
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    local Window = Library:CreateWindow({
        Title = "COMBO_WICK",
        Footer = "検証システム v" .. VaultModule.CONFIG.VERSION,
        Icon = 18928661286,
    ...
    local MainGroup = Tabs.Validation:AddLeftGroupbox("APIキーを入力してください")
    ...
    MainGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "コピーしました",
                Description = "キーリンクをクリップボードにコピーしました",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "コピーしました",
                Description = "YouTubeリンクをクリップボードにコピーしました",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "コピーしました",
                Description = "Discordリンクをクリップボードにコピーしました",
                Time = 2
            })
        end
    })
    ...
    HWIDGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "コピーしました",
                Description = "HWIDをクリップボードにコピーしました",
                Time = 2
            })
        end
    })
