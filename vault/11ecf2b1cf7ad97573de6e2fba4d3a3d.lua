...
-- Created: 2025-12-18T07:36:12.464Z
-- Source: External API
...
local Tabs = {
    ...
    AimAssist = Window:AddTab("Aim Assistant", "star"),
    Visuals = Window:AddTab("Visuales", "eye"),
    ["UI Settings"] = Window:AddTab("Ajustes de UI", "settings"),
}

local AutoPlayBox = Tabs.Respawn:AddLeftGroupbox("Bucle de reproducción automática")
local AimbotV1Box = Tabs.AimAssist:AddLeftGroupbox("Versión 1 - Manual PC")
local AimbotV2Box = Tabs.AimAssist:AddRightGroupbox("Versión 2 - Automática")
local TriggerBox = Tabs.AimAssist:AddLeftGroupbox("Disparo automático")
local ESPBox = Tabs.Visuals:AddLeftGroupbox("Reproductor esp")
local TracerBox = Tabs.Visuals:AddRightGroupbox("Marcadores")

Module.Initialize(Library, Options, Toggles)

AutoPlayBox:AddToggle("Reproducción automática", {
    Text = "Bucle de reproducción automática",
    Default = false,
...
AimbotV1Box:AddToggle("AimbotV1", {
    Text = "Habilitar",
    Default = false,
    Tooltip = "Mantenga pulsado el botón derecho para bloquear",
})
...
AimbotV1Box:AddSlider("AimbotV1Soothing", {
    Text = "Alisado",
    Default = 5,
    Min = 1,
    Max = 20,
...
AimbotV2Box:AddToggle("AimbotV2", {
    Text = "Habilitar",
    Default = false,
    Tooltip = "Botón de bloqueo automático sin",
})
...
ESPBox:AddToggle("HealthBar", {
    Text = "Puesto de comida saludable",
    Default = false,
})
...
TracerBox:AddToggle("Marcadores", {
    Text = "Habilitar",
    Default = false,
})
