...
-- Script ID: 51ba42ca88626f94e33ac0dc24e34694
-- Created: 2026-01-03T00:53:14.070Z
-- Source: External API
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    ...
    local MainGroup = Tabs.Validation:AddLeftGroupbox("Введите свой ключ валидации")
    ...
    MainGroup:AddInput("KeyInput", {
        ...
        Text = "Введите ключ",
        Placeholder = "Вставьте свой ключ здесь...",
