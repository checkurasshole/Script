...
-- Updated: 2026-01-12T02:44:17.670Z
...
if VaultModule.compareVersions(VaultModule.CONFIG.VERSION, '1.3.2') <= 0 then
    Library:Notify({
        ...
        Description = 'รุ่นนี้ไม่ได้รับการสนับสนุนแล้ว โปรดอัปเดตเป็นรุ่น ' .. VaultModule.CONFIG.MIN_VERSION .. ' หรือสูงกว่า',
        Time = 10,
    })
    return {
        success = false,
...
if not whitelisted or errorType == "access_denied" or errorType == "tamper_detected" or errorType == "key_expired" then
    local Window = Library:CreateWindow({
        Title = "COMBO_WICK",
        Footer = "ระบบตรวจสอบความถูกต้อง รุ่น " .. VaultModule.CONFIG.VERSION,
        Icon = 18928661286,
    ...
    local MainGroup = Tabs.Validation:AddLeftGroupbox("ป้อนคีย์ API")
    ...
    MainGroup:AddButton({
        ...
        Func = function()
            ...
            if key == "" then
                Library:Notify({
                    Title = "⚠️ คีย์ว่างเปล่า",
                    Description = "โปรดป้อนคีย์ตรวจสอบความถูกต้อง",
                    Time = 3
                })
                return
            end
    ...
    MainGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "คัดลอกแล้ว",
                Description = "ลิ้งค์คีย์ถูกคัดลอกเข้าคลิปบอร์ด",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "คัดลอกแล้ว",
                Description = "ลิงก์ Youtube ถูกคัดลอกเข้าคลิปบอร์ด",
                Time = 2
            })
        end
    })
    ...
    LinksGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "คัดลอกแล้ว",
                Description = "ลิงก์ Discord ถูกคัดลอกเข้าคลิปบอร์ด",
                Time = 2
            })
        end
    })
    ...
    HWIDGroup:AddButton({
        ...
        Func = function()
            ...
            Library:Notify({
                Title = "คัดลอกแล้ว",
                Description = "HWID ถูกคัดลอกเข้าคลิปบอร์ด",
                Time = 2
            })
        end
    })
