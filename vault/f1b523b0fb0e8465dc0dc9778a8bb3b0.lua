...
-- Script ID: f1b523b0fb0e8465dc0dc9778a8bb3b0
-- Migrated: 2025-09-11T14:25:44.961Z
-- Auto-migrated from encrypted storage to GitHub

local Fluent = loadstring(game:HttpGet("__URL_6f389b3b68d6127c__"))()
local SaveManager = loadstring(game:HttpGet("__URL_88f3897aeff00e9c__"))()
local InterfaceManager = loadstring(game:HttpGet("__URL_ee50daef65928b84__"))()
...
local Tabs = {
    Spawn = Window:AddTab({ Title = "วางไข่ไอเท็ม", Icon = "package" })
}
