-- Script_1754579601591
-- Script ID: 01f8785f0907751390a441c7c52115a9
-- Migrated: 2025-09-11T12:58:14.160Z
...
local Rayfield = loadstring(game:HttpGet('__URL_55ea1dbe460035d5__'))()
...
local AmberTab = Window:CreateTab("Amber Collection", nil)
local UtilityTab = Window:CreateTab("Utilitários", nil)

-- Utility Tab (Anti-Void)
UtilityTab:CreateSection("Antivazio")
UtilityTab:CreateToggle({
    Name = "Ativar Antivazio",
    CurrentValue = false,
    Flag = "AntiVoidToggle",
...
UtilityTab:CreateButton({
    Name = "Fake Out (Teletransporte Ab...",
    Callback = function()
        fakeOut()
    end
})
...
-- Main Tab
Tab:CreateSection("Velocidade de caminhada")
Tab:CreateToggle({
...
Tab:CreateToggle({
    Name = "PNJs de Teletransporte para...",
    CurrentValue = false,
...
Tab:CreateSection("AutoFarm do Jogador")
Tab:CreateToggle({
    Name = "Teletransportar para jogadores",
    CurrentValue = false,
    Flag = "TeleportToggle",
    Callback = function(value)
        teleporting = value
...
Tab:CreateToggle({
    Name = "Alvo Jogadores em Movimento",
    CurrentValue = true,
...
Tab:CreateSlider({
    Name = "Distância Atrás do Inimigo",
    Range = {1, 100},
    Increment = 1,
    Suffix = "studs",
    CurrentValue = 5,
...
AmberTab:CreateSection("Âmbar AutoFarm")
AmberTab:CreateToggle({
    Name = "Ativar a Coleção Âmbar",
    CurrentValue = false,
